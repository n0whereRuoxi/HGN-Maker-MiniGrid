( define ( domain depots )
  ...
  ( :method MAKE-2CRATE
    ...
    :precondition
    ( and ( HOIST-AT ?auto_100 ?auto_98 ) ( IS-CRATE ?auto_95 ) ( not ( = ?auto_99 ?auto_98 ) ) ( HOIST-AT ?auto_97 ?auto_99 ) ( SURFACE-AT ?auto_95 ?auto_99 ) ( ON ?auto_95 ?auto_96 ) ( CLEAR ?auto_95 ) ( not ( = ?auto_94 ?auto_95 ) ) ( not ( = ?auto_94 ?auto_96 ) ) ( not ( = ?auto_95 ?auto_96 ) ) ( not ( = ?auto_100 ?auto_97 ) ) ( SURFACE-AT ?auto_93 ?auto_98 ) ( CLEAR ?auto_93 ) ( IS-CRATE ?auto_94 ) ( AVAILABLE ?auto_100 ) ( AVAILABLE ?auto_97 ) ( SURFACE-AT ?auto_94 ?auto_99 ) ( ON ?auto_94 ?auto_102 ) ( CLEAR ?auto_94 ) ( TRUCK-AT ?auto_101 ?auto_98 ) ( not ( = ?auto_93 ?auto_94 ) ) ( not ( = ?auto_93 ?auto_102 ) ) ( not ( = ?auto_94 ?auto_102 ) ) ( not ( = ?auto_93 ?auto_95 ) ) ( not ( = ?auto_93 ?auto_96 ) ) ( not ( = ?auto_95 ?auto_102 ) ) ( not ( = ?auto_96 ?auto_102 ) ) )
    :subtasks
