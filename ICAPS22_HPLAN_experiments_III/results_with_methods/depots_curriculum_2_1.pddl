( define ( domain depots )
  ...
  ( :method MAKE-2CRATE
    ...
    :precondition
    ( and ( HOIST-AT ?auto_63 ?auto_66 ) ( IS-CRATE ?auto_60 ) ( not ( = ?auto_65 ?auto_66 ) ) ( HOIST-AT ?auto_64 ?auto_65 ) ( AVAILABLE ?auto_64 ) ( SURFACE-AT ?auto_60 ?auto_65 ) ( ON ?auto_60 ?auto_62 ) ( CLEAR ?auto_60 ) ( not ( = ?auto_59 ?auto_60 ) ) ( not ( = ?auto_59 ?auto_62 ) ) ( not ( = ?auto_60 ?auto_62 ) ) ( not ( = ?auto_63 ?auto_64 ) ) ( SURFACE-AT ?auto_58 ?auto_66 ) ( CLEAR ?auto_58 ) ( IS-CRATE ?auto_59 ) ( AVAILABLE ?auto_63 ) ( not ( = ?auto_67 ?auto_66 ) ) ( HOIST-AT ?auto_69 ?auto_67 ) ( AVAILABLE ?auto_69 ) ( SURFACE-AT ?auto_59 ?auto_67 ) ( ON ?auto_59 ?auto_68 ) ( CLEAR ?auto_59 ) ( TRUCK-AT ?auto_61 ?auto_66 ) ( not ( = ?auto_58 ?auto_59 ) ) ( not ( = ?auto_58 ?auto_68 ) ) ( not ( = ?auto_59 ?auto_68 ) ) ( not ( = ?auto_63 ?auto_69 ) ) ( not ( = ?auto_58 ?auto_60 ) ) ( not ( = ?auto_58 ?auto_62 ) ) ( not ( = ?auto_60 ?auto_68 ) ) ( not ( = ?auto_65 ?auto_67 ) ) ( not ( = ?auto_64 ?auto_69 ) ) ( not ( = ?auto_62 ?auto_68 ) ) )
    :subtasks
