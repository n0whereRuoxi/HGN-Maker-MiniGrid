( define ( domain depots )
  ...
  ( :method MAKE-2CRATE
    ...
    :precondition
    ( and ( HOIST-AT ?auto_97 ?auto_100 ) ( IS-CRATE ?auto_95 ) ( not ( = ?auto_101 ?auto_100 ) ) ( HOIST-AT ?auto_99 ?auto_101 ) ( SURFACE-AT ?auto_95 ?auto_101 ) ( ON ?auto_95 ?auto_96 ) ( CLEAR ?auto_95 ) ( not ( = ?auto_94 ?auto_95 ) ) ( not ( = ?auto_94 ?auto_96 ) ) ( not ( = ?auto_95 ?auto_96 ) ) ( not ( = ?auto_97 ?auto_99 ) ) ( SURFACE-AT ?auto_93 ?auto_100 ) ( CLEAR ?auto_93 ) ( IS-CRATE ?auto_94 ) ( AVAILABLE ?auto_97 ) ( AVAILABLE ?auto_99 ) ( SURFACE-AT ?auto_94 ?auto_101 ) ( ON ?auto_94 ?auto_102 ) ( CLEAR ?auto_94 ) ( TRUCK-AT ?auto_98 ?auto_100 ) ( not ( = ?auto_93 ?auto_94 ) ) ( not ( = ?auto_93 ?auto_102 ) ) ( not ( = ?auto_94 ?auto_102 ) ) ( not ( = ?auto_93 ?auto_95 ) ) ( not ( = ?auto_93 ?auto_96 ) ) ( not ( = ?auto_95 ?auto_102 ) ) ( not ( = ?auto_96 ?auto_102 ) ) )
    :subtasks
