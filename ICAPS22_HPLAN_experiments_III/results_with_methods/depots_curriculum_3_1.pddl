( define ( domain depots )
  ...
  ( :method MAKE-2CRATE
    ...
    :precondition
    ( and ( HOIST-AT ?auto_260 ?auto_264 ) ( IS-CRATE ?auto_259 ) ( not ( = ?auto_263 ?auto_264 ) ) ( HOIST-AT ?auto_265 ?auto_263 ) ( AVAILABLE ?auto_265 ) ( SURFACE-AT ?auto_259 ?auto_263 ) ( ON ?auto_259 ?auto_261 ) ( CLEAR ?auto_259 ) ( not ( = ?auto_258 ?auto_259 ) ) ( not ( = ?auto_258 ?auto_261 ) ) ( not ( = ?auto_259 ?auto_261 ) ) ( not ( = ?auto_260 ?auto_265 ) ) ( SURFACE-AT ?auto_257 ?auto_264 ) ( CLEAR ?auto_257 ) ( IS-CRATE ?auto_258 ) ( AVAILABLE ?auto_260 ) ( not ( = ?auto_266 ?auto_264 ) ) ( HOIST-AT ?auto_268 ?auto_266 ) ( AVAILABLE ?auto_268 ) ( SURFACE-AT ?auto_258 ?auto_266 ) ( ON ?auto_258 ?auto_267 ) ( CLEAR ?auto_258 ) ( TRUCK-AT ?auto_262 ?auto_264 ) ( not ( = ?auto_257 ?auto_258 ) ) ( not ( = ?auto_257 ?auto_267 ) ) ( not ( = ?auto_258 ?auto_267 ) ) ( not ( = ?auto_260 ?auto_268 ) ) ( not ( = ?auto_257 ?auto_259 ) ) ( not ( = ?auto_257 ?auto_261 ) ) ( not ( = ?auto_259 ?auto_267 ) ) ( not ( = ?auto_263 ?auto_266 ) ) ( not ( = ?auto_265 ?auto_268 ) ) ( not ( = ?auto_261 ?auto_267 ) ) )
    :subtasks
  ...
  ( :method MAKE-3CRATE
    ...
    :precondition
    ( and ( HOIST-AT ?auto_290 ?auto_287 ) ( IS-CRATE ?auto_286 ) ( not ( = ?auto_292 ?auto_287 ) ) ( HOIST-AT ?auto_289 ?auto_292 ) ( AVAILABLE ?auto_289 ) ( SURFACE-AT ?auto_286 ?auto_292 ) ( ON ?auto_286 ?auto_288 ) ( CLEAR ?auto_286 ) ( not ( = ?auto_285 ?auto_286 ) ) ( not ( = ?auto_285 ?auto_288 ) ) ( not ( = ?auto_286 ?auto_288 ) ) ( not ( = ?auto_290 ?auto_289 ) ) ( IS-CRATE ?auto_285 ) ( not ( = ?auto_293 ?auto_287 ) ) ( HOIST-AT ?auto_294 ?auto_293 ) ( AVAILABLE ?auto_294 ) ( SURFACE-AT ?auto_285 ?auto_293 ) ( ON ?auto_285 ?auto_295 ) ( CLEAR ?auto_285 ) ( not ( = ?auto_284 ?auto_285 ) ) ( not ( = ?auto_284 ?auto_295 ) ) ( not ( = ?auto_285 ?auto_295 ) ) ( not ( = ?auto_290 ?auto_294 ) ) ( SURFACE-AT ?auto_283 ?auto_287 ) ( CLEAR ?auto_283 ) ( IS-CRATE ?auto_284 ) ( AVAILABLE ?auto_290 ) ( not ( = ?auto_296 ?auto_287 ) ) ( HOIST-AT ?auto_298 ?auto_296 ) ( AVAILABLE ?auto_298 ) ( SURFACE-AT ?auto_284 ?auto_296 ) ( ON ?auto_284 ?auto_297 ) ( CLEAR ?auto_284 ) ( TRUCK-AT ?auto_291 ?auto_287 ) ( not ( = ?auto_283 ?auto_284 ) ) ( not ( = ?auto_283 ?auto_297 ) ) ( not ( = ?auto_284 ?auto_297 ) ) ( not ( = ?auto_290 ?auto_298 ) ) ( not ( = ?auto_283 ?auto_285 ) ) ( not ( = ?auto_283 ?auto_295 ) ) ( not ( = ?auto_285 ?auto_297 ) ) ( not ( = ?auto_293 ?auto_296 ) ) ( not ( = ?auto_294 ?auto_298 ) ) ( not ( = ?auto_295 ?auto_297 ) ) ( not ( = ?auto_283 ?auto_286 ) ) ( not ( = ?auto_283 ?auto_288 ) ) ( not ( = ?auto_284 ?auto_286 ) ) ( not ( = ?auto_284 ?auto_288 ) ) ( not ( = ?auto_286 ?auto_295 ) ) ( not ( = ?auto_286 ?auto_297 ) ) ( not ( = ?auto_292 ?auto_293 ) ) ( not ( = ?auto_292 ?auto_296 ) ) ( not ( = ?auto_289 ?auto_294 ) ) ( not ( = ?auto_289 ?auto_298 ) ) ( not ( = ?auto_288 ?auto_295 ) ) ( not ( = ?auto_288 ?auto_297 ) ) )
    :subtasks
