( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_7228 ?auto_7229 ) ( CLEAR ?auto_7228 ) ( HAND-EMPTY ) ( not ( = ?auto_7228 ?auto_7229 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7228 ?auto_7229 )
      ( !PUTDOWN ?auto_7228 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7237 ) ( ON ?auto_7238 ?auto_7239 ) ( CLEAR ?auto_7238 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7237 ) ( not ( = ?auto_7237 ?auto_7238 ) ) ( not ( = ?auto_7237 ?auto_7239 ) ) ( not ( = ?auto_7238 ?auto_7239 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7238 ?auto_7239 )
      ( !STACK ?auto_7238 ?auto_7237 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_7248 ?auto_7249 ) ( not ( = ?auto_7247 ?auto_7248 ) ) ( not ( = ?auto_7247 ?auto_7249 ) ) ( not ( = ?auto_7248 ?auto_7249 ) ) ( ON ?auto_7247 ?auto_7248 ) ( CLEAR ?auto_7247 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7247 )
      ( MAKE-2PILE ?auto_7247 ?auto_7248 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7261 ) ( ON ?auto_7262 ?auto_7263 ) ( CLEAR ?auto_7262 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7260 ) ( ON ?auto_7261 ?auto_7260 ) ( not ( = ?auto_7260 ?auto_7261 ) ) ( not ( = ?auto_7260 ?auto_7262 ) ) ( not ( = ?auto_7260 ?auto_7263 ) ) ( not ( = ?auto_7261 ?auto_7262 ) ) ( not ( = ?auto_7261 ?auto_7263 ) ) ( not ( = ?auto_7262 ?auto_7263 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7262 ?auto_7263 )
      ( !STACK ?auto_7262 ?auto_7261 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_7276 ?auto_7277 ) ( ON-TABLE ?auto_7274 ) ( not ( = ?auto_7274 ?auto_7275 ) ) ( not ( = ?auto_7274 ?auto_7276 ) ) ( not ( = ?auto_7274 ?auto_7277 ) ) ( not ( = ?auto_7275 ?auto_7276 ) ) ( not ( = ?auto_7275 ?auto_7277 ) ) ( not ( = ?auto_7276 ?auto_7277 ) ) ( CLEAR ?auto_7274 ) ( ON ?auto_7275 ?auto_7276 ) ( CLEAR ?auto_7275 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_7274 ?auto_7275 )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_7290 ?auto_7291 ) ( not ( = ?auto_7288 ?auto_7289 ) ) ( not ( = ?auto_7288 ?auto_7290 ) ) ( not ( = ?auto_7288 ?auto_7291 ) ) ( not ( = ?auto_7289 ?auto_7290 ) ) ( not ( = ?auto_7289 ?auto_7291 ) ) ( not ( = ?auto_7290 ?auto_7291 ) ) ( ON ?auto_7289 ?auto_7290 ) ( ON ?auto_7288 ?auto_7289 ) ( CLEAR ?auto_7288 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7288 )
      ( MAKE-3PILE ?auto_7288 ?auto_7289 ?auto_7290 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7307 ) ( ON ?auto_7308 ?auto_7309 ) ( CLEAR ?auto_7308 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7305 ) ( ON ?auto_7306 ?auto_7305 ) ( ON ?auto_7307 ?auto_7306 ) ( not ( = ?auto_7305 ?auto_7306 ) ) ( not ( = ?auto_7305 ?auto_7307 ) ) ( not ( = ?auto_7305 ?auto_7308 ) ) ( not ( = ?auto_7305 ?auto_7309 ) ) ( not ( = ?auto_7306 ?auto_7307 ) ) ( not ( = ?auto_7306 ?auto_7308 ) ) ( not ( = ?auto_7306 ?auto_7309 ) ) ( not ( = ?auto_7307 ?auto_7308 ) ) ( not ( = ?auto_7307 ?auto_7309 ) ) ( not ( = ?auto_7308 ?auto_7309 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7308 ?auto_7309 )
      ( !STACK ?auto_7308 ?auto_7307 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7326 ?auto_7327 ) ( ON-TABLE ?auto_7323 ) ( ON ?auto_7324 ?auto_7323 ) ( not ( = ?auto_7323 ?auto_7324 ) ) ( not ( = ?auto_7323 ?auto_7325 ) ) ( not ( = ?auto_7323 ?auto_7326 ) ) ( not ( = ?auto_7323 ?auto_7327 ) ) ( not ( = ?auto_7324 ?auto_7325 ) ) ( not ( = ?auto_7324 ?auto_7326 ) ) ( not ( = ?auto_7324 ?auto_7327 ) ) ( not ( = ?auto_7325 ?auto_7326 ) ) ( not ( = ?auto_7325 ?auto_7327 ) ) ( not ( = ?auto_7326 ?auto_7327 ) ) ( CLEAR ?auto_7324 ) ( ON ?auto_7325 ?auto_7326 ) ( CLEAR ?auto_7325 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_7323 ?auto_7324 ?auto_7325 )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7344 ?auto_7345 ) ( ON-TABLE ?auto_7341 ) ( not ( = ?auto_7341 ?auto_7342 ) ) ( not ( = ?auto_7341 ?auto_7343 ) ) ( not ( = ?auto_7341 ?auto_7344 ) ) ( not ( = ?auto_7341 ?auto_7345 ) ) ( not ( = ?auto_7342 ?auto_7343 ) ) ( not ( = ?auto_7342 ?auto_7344 ) ) ( not ( = ?auto_7342 ?auto_7345 ) ) ( not ( = ?auto_7343 ?auto_7344 ) ) ( not ( = ?auto_7343 ?auto_7345 ) ) ( not ( = ?auto_7344 ?auto_7345 ) ) ( ON ?auto_7343 ?auto_7344 ) ( CLEAR ?auto_7341 ) ( ON ?auto_7342 ?auto_7343 ) ( CLEAR ?auto_7342 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7362 ?auto_7363 ) ( not ( = ?auto_7359 ?auto_7360 ) ) ( not ( = ?auto_7359 ?auto_7361 ) ) ( not ( = ?auto_7359 ?auto_7362 ) ) ( not ( = ?auto_7359 ?auto_7363 ) ) ( not ( = ?auto_7360 ?auto_7361 ) ) ( not ( = ?auto_7360 ?auto_7362 ) ) ( not ( = ?auto_7360 ?auto_7363 ) ) ( not ( = ?auto_7361 ?auto_7362 ) ) ( not ( = ?auto_7361 ?auto_7363 ) ) ( not ( = ?auto_7362 ?auto_7363 ) ) ( ON ?auto_7361 ?auto_7362 ) ( ON ?auto_7360 ?auto_7361 ) ( ON ?auto_7359 ?auto_7360 ) ( CLEAR ?auto_7359 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7359 )
      ( MAKE-4PILE ?auto_7359 ?auto_7360 ?auto_7361 ?auto_7362 ) )
  )
