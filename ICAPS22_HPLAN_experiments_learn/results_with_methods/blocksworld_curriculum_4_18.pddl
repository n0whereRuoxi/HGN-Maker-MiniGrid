( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_4634 ?auto_4635 ) ( CLEAR ?auto_4634 ) ( HAND-EMPTY ) ( not ( = ?auto_4634 ?auto_4635 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4634 ?auto_4635 )
      ( !PUTDOWN ?auto_4634 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4643 ) ( ON ?auto_4644 ?auto_4645 ) ( CLEAR ?auto_4644 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4643 ) ( not ( = ?auto_4643 ?auto_4644 ) ) ( not ( = ?auto_4643 ?auto_4645 ) ) ( not ( = ?auto_4644 ?auto_4645 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4644 ?auto_4645 )
      ( !STACK ?auto_4644 ?auto_4643 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_4654 ?auto_4655 ) ( not ( = ?auto_4653 ?auto_4654 ) ) ( not ( = ?auto_4653 ?auto_4655 ) ) ( not ( = ?auto_4654 ?auto_4655 ) ) ( ON ?auto_4653 ?auto_4654 ) ( CLEAR ?auto_4653 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4653 )
      ( MAKE-2PILE ?auto_4653 ?auto_4654 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4667 ) ( ON ?auto_4668 ?auto_4669 ) ( CLEAR ?auto_4668 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4666 ) ( ON ?auto_4667 ?auto_4666 ) ( not ( = ?auto_4666 ?auto_4667 ) ) ( not ( = ?auto_4666 ?auto_4668 ) ) ( not ( = ?auto_4666 ?auto_4669 ) ) ( not ( = ?auto_4667 ?auto_4668 ) ) ( not ( = ?auto_4667 ?auto_4669 ) ) ( not ( = ?auto_4668 ?auto_4669 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4668 ?auto_4669 )
      ( !STACK ?auto_4668 ?auto_4667 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4682 ?auto_4683 ) ( ON-TABLE ?auto_4680 ) ( not ( = ?auto_4680 ?auto_4681 ) ) ( not ( = ?auto_4680 ?auto_4682 ) ) ( not ( = ?auto_4680 ?auto_4683 ) ) ( not ( = ?auto_4681 ?auto_4682 ) ) ( not ( = ?auto_4681 ?auto_4683 ) ) ( not ( = ?auto_4682 ?auto_4683 ) ) ( CLEAR ?auto_4680 ) ( ON ?auto_4681 ?auto_4682 ) ( CLEAR ?auto_4681 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_4680 ?auto_4681 )
      ( MAKE-3PILE ?auto_4680 ?auto_4681 ?auto_4682 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4696 ?auto_4697 ) ( not ( = ?auto_4694 ?auto_4695 ) ) ( not ( = ?auto_4694 ?auto_4696 ) ) ( not ( = ?auto_4694 ?auto_4697 ) ) ( not ( = ?auto_4695 ?auto_4696 ) ) ( not ( = ?auto_4695 ?auto_4697 ) ) ( not ( = ?auto_4696 ?auto_4697 ) ) ( ON ?auto_4695 ?auto_4696 ) ( ON ?auto_4694 ?auto_4695 ) ( CLEAR ?auto_4694 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4694 )
      ( MAKE-3PILE ?auto_4694 ?auto_4695 ?auto_4696 ) )
  )
