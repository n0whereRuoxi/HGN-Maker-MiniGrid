( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_6204 ?auto_6205 ) ( CLEAR ?auto_6204 ) ( HAND-EMPTY ) ( not ( = ?auto_6204 ?auto_6205 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6204 ?auto_6205 )
      ( !PUTDOWN ?auto_6204 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6213 ) ( ON ?auto_6214 ?auto_6215 ) ( CLEAR ?auto_6214 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6213 ) ( not ( = ?auto_6213 ?auto_6214 ) ) ( not ( = ?auto_6213 ?auto_6215 ) ) ( not ( = ?auto_6214 ?auto_6215 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6214 ?auto_6215 )
      ( !STACK ?auto_6214 ?auto_6213 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_6224 ?auto_6225 ) ( not ( = ?auto_6223 ?auto_6224 ) ) ( not ( = ?auto_6223 ?auto_6225 ) ) ( not ( = ?auto_6224 ?auto_6225 ) ) ( ON ?auto_6223 ?auto_6224 ) ( CLEAR ?auto_6223 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6237 ) ( ON ?auto_6238 ?auto_6239 ) ( CLEAR ?auto_6238 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6236 ) ( ON ?auto_6237 ?auto_6236 ) ( not ( = ?auto_6236 ?auto_6237 ) ) ( not ( = ?auto_6236 ?auto_6238 ) ) ( not ( = ?auto_6236 ?auto_6239 ) ) ( not ( = ?auto_6237 ?auto_6238 ) ) ( not ( = ?auto_6237 ?auto_6239 ) ) ( not ( = ?auto_6238 ?auto_6239 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6238 ?auto_6239 )
      ( !STACK ?auto_6238 ?auto_6237 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6252 ?auto_6253 ) ( ON-TABLE ?auto_6250 ) ( not ( = ?auto_6250 ?auto_6251 ) ) ( not ( = ?auto_6250 ?auto_6252 ) ) ( not ( = ?auto_6250 ?auto_6253 ) ) ( not ( = ?auto_6251 ?auto_6252 ) ) ( not ( = ?auto_6251 ?auto_6253 ) ) ( not ( = ?auto_6252 ?auto_6253 ) ) ( CLEAR ?auto_6250 ) ( ON ?auto_6251 ?auto_6252 ) ( CLEAR ?auto_6251 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6250 ?auto_6251 )
      ( MAKE-3PILE ?auto_6250 ?auto_6251 ?auto_6252 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6266 ?auto_6267 ) ( not ( = ?auto_6264 ?auto_6265 ) ) ( not ( = ?auto_6264 ?auto_6266 ) ) ( not ( = ?auto_6264 ?auto_6267 ) ) ( not ( = ?auto_6265 ?auto_6266 ) ) ( not ( = ?auto_6265 ?auto_6267 ) ) ( not ( = ?auto_6266 ?auto_6267 ) ) ( ON ?auto_6265 ?auto_6266 ) ( ON ?auto_6264 ?auto_6265 ) ( CLEAR ?auto_6264 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6264 )
      ( MAKE-3PILE ?auto_6264 ?auto_6265 ?auto_6266 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6283 ) ( ON ?auto_6284 ?auto_6285 ) ( CLEAR ?auto_6284 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6281 ) ( ON ?auto_6282 ?auto_6281 ) ( ON ?auto_6283 ?auto_6282 ) ( not ( = ?auto_6281 ?auto_6282 ) ) ( not ( = ?auto_6281 ?auto_6283 ) ) ( not ( = ?auto_6281 ?auto_6284 ) ) ( not ( = ?auto_6281 ?auto_6285 ) ) ( not ( = ?auto_6282 ?auto_6283 ) ) ( not ( = ?auto_6282 ?auto_6284 ) ) ( not ( = ?auto_6282 ?auto_6285 ) ) ( not ( = ?auto_6283 ?auto_6284 ) ) ( not ( = ?auto_6283 ?auto_6285 ) ) ( not ( = ?auto_6284 ?auto_6285 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6284 ?auto_6285 )
      ( !STACK ?auto_6284 ?auto_6283 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6302 ?auto_6303 ) ( ON-TABLE ?auto_6299 ) ( ON ?auto_6300 ?auto_6299 ) ( not ( = ?auto_6299 ?auto_6300 ) ) ( not ( = ?auto_6299 ?auto_6301 ) ) ( not ( = ?auto_6299 ?auto_6302 ) ) ( not ( = ?auto_6299 ?auto_6303 ) ) ( not ( = ?auto_6300 ?auto_6301 ) ) ( not ( = ?auto_6300 ?auto_6302 ) ) ( not ( = ?auto_6300 ?auto_6303 ) ) ( not ( = ?auto_6301 ?auto_6302 ) ) ( not ( = ?auto_6301 ?auto_6303 ) ) ( not ( = ?auto_6302 ?auto_6303 ) ) ( CLEAR ?auto_6300 ) ( ON ?auto_6301 ?auto_6302 ) ( CLEAR ?auto_6301 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_6299 ?auto_6300 ?auto_6301 )
      ( MAKE-4PILE ?auto_6299 ?auto_6300 ?auto_6301 ?auto_6302 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6320 ?auto_6321 ) ( ON-TABLE ?auto_6317 ) ( not ( = ?auto_6317 ?auto_6318 ) ) ( not ( = ?auto_6317 ?auto_6319 ) ) ( not ( = ?auto_6317 ?auto_6320 ) ) ( not ( = ?auto_6317 ?auto_6321 ) ) ( not ( = ?auto_6318 ?auto_6319 ) ) ( not ( = ?auto_6318 ?auto_6320 ) ) ( not ( = ?auto_6318 ?auto_6321 ) ) ( not ( = ?auto_6319 ?auto_6320 ) ) ( not ( = ?auto_6319 ?auto_6321 ) ) ( not ( = ?auto_6320 ?auto_6321 ) ) ( ON ?auto_6319 ?auto_6320 ) ( CLEAR ?auto_6317 ) ( ON ?auto_6318 ?auto_6319 ) ( CLEAR ?auto_6318 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6317 ?auto_6318 )
      ( MAKE-4PILE ?auto_6317 ?auto_6318 ?auto_6319 ?auto_6320 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6338 ?auto_6339 ) ( not ( = ?auto_6335 ?auto_6336 ) ) ( not ( = ?auto_6335 ?auto_6337 ) ) ( not ( = ?auto_6335 ?auto_6338 ) ) ( not ( = ?auto_6335 ?auto_6339 ) ) ( not ( = ?auto_6336 ?auto_6337 ) ) ( not ( = ?auto_6336 ?auto_6338 ) ) ( not ( = ?auto_6336 ?auto_6339 ) ) ( not ( = ?auto_6337 ?auto_6338 ) ) ( not ( = ?auto_6337 ?auto_6339 ) ) ( not ( = ?auto_6338 ?auto_6339 ) ) ( ON ?auto_6337 ?auto_6338 ) ( ON ?auto_6336 ?auto_6337 ) ( ON ?auto_6335 ?auto_6336 ) ( CLEAR ?auto_6335 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6335 )
      ( MAKE-4PILE ?auto_6335 ?auto_6336 ?auto_6337 ?auto_6338 ) )
  )
