( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_12935 ?auto_12936 ) ( CLEAR ?auto_12935 ) ( HAND-EMPTY ) ( not ( = ?auto_12935 ?auto_12936 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_12935 ?auto_12936 )
      ( !PUTDOWN ?auto_12935 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_12944 ) ( ON ?auto_12945 ?auto_12946 ) ( CLEAR ?auto_12945 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_12944 ) ( not ( = ?auto_12944 ?auto_12945 ) ) ( not ( = ?auto_12944 ?auto_12946 ) ) ( not ( = ?auto_12945 ?auto_12946 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_12945 ?auto_12946 )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_12955 ?auto_12956 ) ( not ( = ?auto_12954 ?auto_12955 ) ) ( not ( = ?auto_12954 ?auto_12956 ) ) ( not ( = ?auto_12955 ?auto_12956 ) ) ( ON ?auto_12954 ?auto_12955 ) ( CLEAR ?auto_12954 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_12954 )
      ( MAKE-2PILE ?auto_12954 ?auto_12955 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_12968 ) ( ON ?auto_12969 ?auto_12970 ) ( CLEAR ?auto_12969 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_12967 ) ( ON ?auto_12968 ?auto_12967 ) ( not ( = ?auto_12967 ?auto_12968 ) ) ( not ( = ?auto_12967 ?auto_12969 ) ) ( not ( = ?auto_12967 ?auto_12970 ) ) ( not ( = ?auto_12968 ?auto_12969 ) ) ( not ( = ?auto_12968 ?auto_12970 ) ) ( not ( = ?auto_12969 ?auto_12970 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_12969 ?auto_12970 )
      ( !STACK ?auto_12969 ?auto_12968 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_12983 ?auto_12984 ) ( ON-TABLE ?auto_12981 ) ( not ( = ?auto_12981 ?auto_12982 ) ) ( not ( = ?auto_12981 ?auto_12983 ) ) ( not ( = ?auto_12981 ?auto_12984 ) ) ( not ( = ?auto_12982 ?auto_12983 ) ) ( not ( = ?auto_12982 ?auto_12984 ) ) ( not ( = ?auto_12983 ?auto_12984 ) ) ( CLEAR ?auto_12981 ) ( ON ?auto_12982 ?auto_12983 ) ( CLEAR ?auto_12982 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_12981 ?auto_12982 )
      ( MAKE-3PILE ?auto_12981 ?auto_12982 ?auto_12983 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_12997 ?auto_12998 ) ( not ( = ?auto_12995 ?auto_12996 ) ) ( not ( = ?auto_12995 ?auto_12997 ) ) ( not ( = ?auto_12995 ?auto_12998 ) ) ( not ( = ?auto_12996 ?auto_12997 ) ) ( not ( = ?auto_12996 ?auto_12998 ) ) ( not ( = ?auto_12997 ?auto_12998 ) ) ( ON ?auto_12996 ?auto_12997 ) ( ON ?auto_12995 ?auto_12996 ) ( CLEAR ?auto_12995 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_12995 )
      ( MAKE-3PILE ?auto_12995 ?auto_12996 ?auto_12997 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_13014 ) ( ON ?auto_13015 ?auto_13016 ) ( CLEAR ?auto_13015 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_13012 ) ( ON ?auto_13013 ?auto_13012 ) ( ON ?auto_13014 ?auto_13013 ) ( not ( = ?auto_13012 ?auto_13013 ) ) ( not ( = ?auto_13012 ?auto_13014 ) ) ( not ( = ?auto_13012 ?auto_13015 ) ) ( not ( = ?auto_13012 ?auto_13016 ) ) ( not ( = ?auto_13013 ?auto_13014 ) ) ( not ( = ?auto_13013 ?auto_13015 ) ) ( not ( = ?auto_13013 ?auto_13016 ) ) ( not ( = ?auto_13014 ?auto_13015 ) ) ( not ( = ?auto_13014 ?auto_13016 ) ) ( not ( = ?auto_13015 ?auto_13016 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_13015 ?auto_13016 )
      ( !STACK ?auto_13015 ?auto_13014 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_13033 ?auto_13034 ) ( ON-TABLE ?auto_13030 ) ( ON ?auto_13031 ?auto_13030 ) ( not ( = ?auto_13030 ?auto_13031 ) ) ( not ( = ?auto_13030 ?auto_13032 ) ) ( not ( = ?auto_13030 ?auto_13033 ) ) ( not ( = ?auto_13030 ?auto_13034 ) ) ( not ( = ?auto_13031 ?auto_13032 ) ) ( not ( = ?auto_13031 ?auto_13033 ) ) ( not ( = ?auto_13031 ?auto_13034 ) ) ( not ( = ?auto_13032 ?auto_13033 ) ) ( not ( = ?auto_13032 ?auto_13034 ) ) ( not ( = ?auto_13033 ?auto_13034 ) ) ( CLEAR ?auto_13031 ) ( ON ?auto_13032 ?auto_13033 ) ( CLEAR ?auto_13032 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_13030 ?auto_13031 ?auto_13032 )
      ( MAKE-4PILE ?auto_13030 ?auto_13031 ?auto_13032 ?auto_13033 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_13051 ?auto_13052 ) ( ON-TABLE ?auto_13048 ) ( not ( = ?auto_13048 ?auto_13049 ) ) ( not ( = ?auto_13048 ?auto_13050 ) ) ( not ( = ?auto_13048 ?auto_13051 ) ) ( not ( = ?auto_13048 ?auto_13052 ) ) ( not ( = ?auto_13049 ?auto_13050 ) ) ( not ( = ?auto_13049 ?auto_13051 ) ) ( not ( = ?auto_13049 ?auto_13052 ) ) ( not ( = ?auto_13050 ?auto_13051 ) ) ( not ( = ?auto_13050 ?auto_13052 ) ) ( not ( = ?auto_13051 ?auto_13052 ) ) ( ON ?auto_13050 ?auto_13051 ) ( CLEAR ?auto_13048 ) ( ON ?auto_13049 ?auto_13050 ) ( CLEAR ?auto_13049 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_13048 ?auto_13049 )
      ( MAKE-4PILE ?auto_13048 ?auto_13049 ?auto_13050 ?auto_13051 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_13069 ?auto_13070 ) ( not ( = ?auto_13066 ?auto_13067 ) ) ( not ( = ?auto_13066 ?auto_13068 ) ) ( not ( = ?auto_13066 ?auto_13069 ) ) ( not ( = ?auto_13066 ?auto_13070 ) ) ( not ( = ?auto_13067 ?auto_13068 ) ) ( not ( = ?auto_13067 ?auto_13069 ) ) ( not ( = ?auto_13067 ?auto_13070 ) ) ( not ( = ?auto_13068 ?auto_13069 ) ) ( not ( = ?auto_13068 ?auto_13070 ) ) ( not ( = ?auto_13069 ?auto_13070 ) ) ( ON ?auto_13068 ?auto_13069 ) ( ON ?auto_13067 ?auto_13068 ) ( ON ?auto_13066 ?auto_13067 ) ( CLEAR ?auto_13066 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_13066 )
      ( MAKE-4PILE ?auto_13066 ?auto_13067 ?auto_13068 ?auto_13069 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_13090 ) ( ON ?auto_13091 ?auto_13092 ) ( CLEAR ?auto_13091 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_13087 ) ( ON ?auto_13088 ?auto_13087 ) ( ON ?auto_13089 ?auto_13088 ) ( ON ?auto_13090 ?auto_13089 ) ( not ( = ?auto_13087 ?auto_13088 ) ) ( not ( = ?auto_13087 ?auto_13089 ) ) ( not ( = ?auto_13087 ?auto_13090 ) ) ( not ( = ?auto_13087 ?auto_13091 ) ) ( not ( = ?auto_13087 ?auto_13092 ) ) ( not ( = ?auto_13088 ?auto_13089 ) ) ( not ( = ?auto_13088 ?auto_13090 ) ) ( not ( = ?auto_13088 ?auto_13091 ) ) ( not ( = ?auto_13088 ?auto_13092 ) ) ( not ( = ?auto_13089 ?auto_13090 ) ) ( not ( = ?auto_13089 ?auto_13091 ) ) ( not ( = ?auto_13089 ?auto_13092 ) ) ( not ( = ?auto_13090 ?auto_13091 ) ) ( not ( = ?auto_13090 ?auto_13092 ) ) ( not ( = ?auto_13091 ?auto_13092 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_13091 ?auto_13092 )
      ( !STACK ?auto_13091 ?auto_13090 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_13113 ?auto_13114 ) ( ON-TABLE ?auto_13109 ) ( ON ?auto_13110 ?auto_13109 ) ( ON ?auto_13111 ?auto_13110 ) ( not ( = ?auto_13109 ?auto_13110 ) ) ( not ( = ?auto_13109 ?auto_13111 ) ) ( not ( = ?auto_13109 ?auto_13112 ) ) ( not ( = ?auto_13109 ?auto_13113 ) ) ( not ( = ?auto_13109 ?auto_13114 ) ) ( not ( = ?auto_13110 ?auto_13111 ) ) ( not ( = ?auto_13110 ?auto_13112 ) ) ( not ( = ?auto_13110 ?auto_13113 ) ) ( not ( = ?auto_13110 ?auto_13114 ) ) ( not ( = ?auto_13111 ?auto_13112 ) ) ( not ( = ?auto_13111 ?auto_13113 ) ) ( not ( = ?auto_13111 ?auto_13114 ) ) ( not ( = ?auto_13112 ?auto_13113 ) ) ( not ( = ?auto_13112 ?auto_13114 ) ) ( not ( = ?auto_13113 ?auto_13114 ) ) ( CLEAR ?auto_13111 ) ( ON ?auto_13112 ?auto_13113 ) ( CLEAR ?auto_13112 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-4PILE ?auto_13109 ?auto_13110 ?auto_13111 ?auto_13112 )
      ( MAKE-5PILE ?auto_13109 ?auto_13110 ?auto_13111 ?auto_13112 ?auto_13113 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_13135 ?auto_13136 ) ( ON-TABLE ?auto_13131 ) ( ON ?auto_13132 ?auto_13131 ) ( not ( = ?auto_13131 ?auto_13132 ) ) ( not ( = ?auto_13131 ?auto_13133 ) ) ( not ( = ?auto_13131 ?auto_13134 ) ) ( not ( = ?auto_13131 ?auto_13135 ) ) ( not ( = ?auto_13131 ?auto_13136 ) ) ( not ( = ?auto_13132 ?auto_13133 ) ) ( not ( = ?auto_13132 ?auto_13134 ) ) ( not ( = ?auto_13132 ?auto_13135 ) ) ( not ( = ?auto_13132 ?auto_13136 ) ) ( not ( = ?auto_13133 ?auto_13134 ) ) ( not ( = ?auto_13133 ?auto_13135 ) ) ( not ( = ?auto_13133 ?auto_13136 ) ) ( not ( = ?auto_13134 ?auto_13135 ) ) ( not ( = ?auto_13134 ?auto_13136 ) ) ( not ( = ?auto_13135 ?auto_13136 ) ) ( ON ?auto_13134 ?auto_13135 ) ( CLEAR ?auto_13132 ) ( ON ?auto_13133 ?auto_13134 ) ( CLEAR ?auto_13133 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_13131 ?auto_13132 ?auto_13133 )
      ( MAKE-5PILE ?auto_13131 ?auto_13132 ?auto_13133 ?auto_13134 ?auto_13135 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_13157 ?auto_13158 ) ( ON-TABLE ?auto_13153 ) ( not ( = ?auto_13153 ?auto_13154 ) ) ( not ( = ?auto_13153 ?auto_13155 ) ) ( not ( = ?auto_13153 ?auto_13156 ) ) ( not ( = ?auto_13153 ?auto_13157 ) ) ( not ( = ?auto_13153 ?auto_13158 ) ) ( not ( = ?auto_13154 ?auto_13155 ) ) ( not ( = ?auto_13154 ?auto_13156 ) ) ( not ( = ?auto_13154 ?auto_13157 ) ) ( not ( = ?auto_13154 ?auto_13158 ) ) ( not ( = ?auto_13155 ?auto_13156 ) ) ( not ( = ?auto_13155 ?auto_13157 ) ) ( not ( = ?auto_13155 ?auto_13158 ) ) ( not ( = ?auto_13156 ?auto_13157 ) ) ( not ( = ?auto_13156 ?auto_13158 ) ) ( not ( = ?auto_13157 ?auto_13158 ) ) ( ON ?auto_13156 ?auto_13157 ) ( ON ?auto_13155 ?auto_13156 ) ( CLEAR ?auto_13153 ) ( ON ?auto_13154 ?auto_13155 ) ( CLEAR ?auto_13154 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_13153 ?auto_13154 )
      ( MAKE-5PILE ?auto_13153 ?auto_13154 ?auto_13155 ?auto_13156 ?auto_13157 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_13179 ?auto_13180 ) ( not ( = ?auto_13175 ?auto_13176 ) ) ( not ( = ?auto_13175 ?auto_13177 ) ) ( not ( = ?auto_13175 ?auto_13178 ) ) ( not ( = ?auto_13175 ?auto_13179 ) ) ( not ( = ?auto_13175 ?auto_13180 ) ) ( not ( = ?auto_13176 ?auto_13177 ) ) ( not ( = ?auto_13176 ?auto_13178 ) ) ( not ( = ?auto_13176 ?auto_13179 ) ) ( not ( = ?auto_13176 ?auto_13180 ) ) ( not ( = ?auto_13177 ?auto_13178 ) ) ( not ( = ?auto_13177 ?auto_13179 ) ) ( not ( = ?auto_13177 ?auto_13180 ) ) ( not ( = ?auto_13178 ?auto_13179 ) ) ( not ( = ?auto_13178 ?auto_13180 ) ) ( not ( = ?auto_13179 ?auto_13180 ) ) ( ON ?auto_13178 ?auto_13179 ) ( ON ?auto_13177 ?auto_13178 ) ( ON ?auto_13176 ?auto_13177 ) ( ON ?auto_13175 ?auto_13176 ) ( CLEAR ?auto_13175 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_13175 )
      ( MAKE-5PILE ?auto_13175 ?auto_13176 ?auto_13177 ?auto_13178 ?auto_13179 ) )
  )
