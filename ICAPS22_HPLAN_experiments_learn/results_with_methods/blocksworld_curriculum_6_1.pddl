( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_10457 ?auto_10458 ) ( CLEAR ?auto_10457 ) ( HAND-EMPTY ) ( not ( = ?auto_10457 ?auto_10458 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_10457 ?auto_10458 )
      ( !PUTDOWN ?auto_10457 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_10466 ) ( ON ?auto_10467 ?auto_10468 ) ( CLEAR ?auto_10467 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_10466 ) ( not ( = ?auto_10466 ?auto_10467 ) ) ( not ( = ?auto_10466 ?auto_10468 ) ) ( not ( = ?auto_10467 ?auto_10468 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_10467 ?auto_10468 )
      ( !STACK ?auto_10467 ?auto_10466 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_10477 ?auto_10478 ) ( not ( = ?auto_10476 ?auto_10477 ) ) ( not ( = ?auto_10476 ?auto_10478 ) ) ( not ( = ?auto_10477 ?auto_10478 ) ) ( ON ?auto_10476 ?auto_10477 ) ( CLEAR ?auto_10476 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_10476 )
      ( MAKE-2PILE ?auto_10476 ?auto_10477 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_10490 ) ( ON ?auto_10491 ?auto_10492 ) ( CLEAR ?auto_10491 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_10489 ) ( ON ?auto_10490 ?auto_10489 ) ( not ( = ?auto_10489 ?auto_10490 ) ) ( not ( = ?auto_10489 ?auto_10491 ) ) ( not ( = ?auto_10489 ?auto_10492 ) ) ( not ( = ?auto_10490 ?auto_10491 ) ) ( not ( = ?auto_10490 ?auto_10492 ) ) ( not ( = ?auto_10491 ?auto_10492 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_10491 ?auto_10492 )
      ( !STACK ?auto_10491 ?auto_10490 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_10505 ?auto_10506 ) ( ON-TABLE ?auto_10503 ) ( not ( = ?auto_10503 ?auto_10504 ) ) ( not ( = ?auto_10503 ?auto_10505 ) ) ( not ( = ?auto_10503 ?auto_10506 ) ) ( not ( = ?auto_10504 ?auto_10505 ) ) ( not ( = ?auto_10504 ?auto_10506 ) ) ( not ( = ?auto_10505 ?auto_10506 ) ) ( CLEAR ?auto_10503 ) ( ON ?auto_10504 ?auto_10505 ) ( CLEAR ?auto_10504 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_10503 ?auto_10504 )
      ( MAKE-3PILE ?auto_10503 ?auto_10504 ?auto_10505 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_10519 ?auto_10520 ) ( not ( = ?auto_10517 ?auto_10518 ) ) ( not ( = ?auto_10517 ?auto_10519 ) ) ( not ( = ?auto_10517 ?auto_10520 ) ) ( not ( = ?auto_10518 ?auto_10519 ) ) ( not ( = ?auto_10518 ?auto_10520 ) ) ( not ( = ?auto_10519 ?auto_10520 ) ) ( ON ?auto_10518 ?auto_10519 ) ( ON ?auto_10517 ?auto_10518 ) ( CLEAR ?auto_10517 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_10517 )
      ( MAKE-3PILE ?auto_10517 ?auto_10518 ?auto_10519 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_10536 ) ( ON ?auto_10537 ?auto_10538 ) ( CLEAR ?auto_10537 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_10534 ) ( ON ?auto_10535 ?auto_10534 ) ( ON ?auto_10536 ?auto_10535 ) ( not ( = ?auto_10534 ?auto_10535 ) ) ( not ( = ?auto_10534 ?auto_10536 ) ) ( not ( = ?auto_10534 ?auto_10537 ) ) ( not ( = ?auto_10534 ?auto_10538 ) ) ( not ( = ?auto_10535 ?auto_10536 ) ) ( not ( = ?auto_10535 ?auto_10537 ) ) ( not ( = ?auto_10535 ?auto_10538 ) ) ( not ( = ?auto_10536 ?auto_10537 ) ) ( not ( = ?auto_10536 ?auto_10538 ) ) ( not ( = ?auto_10537 ?auto_10538 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_10537 ?auto_10538 )
      ( !STACK ?auto_10537 ?auto_10536 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_10555 ?auto_10556 ) ( ON-TABLE ?auto_10552 ) ( ON ?auto_10553 ?auto_10552 ) ( not ( = ?auto_10552 ?auto_10553 ) ) ( not ( = ?auto_10552 ?auto_10554 ) ) ( not ( = ?auto_10552 ?auto_10555 ) ) ( not ( = ?auto_10552 ?auto_10556 ) ) ( not ( = ?auto_10553 ?auto_10554 ) ) ( not ( = ?auto_10553 ?auto_10555 ) ) ( not ( = ?auto_10553 ?auto_10556 ) ) ( not ( = ?auto_10554 ?auto_10555 ) ) ( not ( = ?auto_10554 ?auto_10556 ) ) ( not ( = ?auto_10555 ?auto_10556 ) ) ( CLEAR ?auto_10553 ) ( ON ?auto_10554 ?auto_10555 ) ( CLEAR ?auto_10554 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_10552 ?auto_10553 ?auto_10554 )
      ( MAKE-4PILE ?auto_10552 ?auto_10553 ?auto_10554 ?auto_10555 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_10573 ?auto_10574 ) ( ON-TABLE ?auto_10570 ) ( not ( = ?auto_10570 ?auto_10571 ) ) ( not ( = ?auto_10570 ?auto_10572 ) ) ( not ( = ?auto_10570 ?auto_10573 ) ) ( not ( = ?auto_10570 ?auto_10574 ) ) ( not ( = ?auto_10571 ?auto_10572 ) ) ( not ( = ?auto_10571 ?auto_10573 ) ) ( not ( = ?auto_10571 ?auto_10574 ) ) ( not ( = ?auto_10572 ?auto_10573 ) ) ( not ( = ?auto_10572 ?auto_10574 ) ) ( not ( = ?auto_10573 ?auto_10574 ) ) ( ON ?auto_10572 ?auto_10573 ) ( CLEAR ?auto_10570 ) ( ON ?auto_10571 ?auto_10572 ) ( CLEAR ?auto_10571 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_10570 ?auto_10571 )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_10591 ?auto_10592 ) ( not ( = ?auto_10588 ?auto_10589 ) ) ( not ( = ?auto_10588 ?auto_10590 ) ) ( not ( = ?auto_10588 ?auto_10591 ) ) ( not ( = ?auto_10588 ?auto_10592 ) ) ( not ( = ?auto_10589 ?auto_10590 ) ) ( not ( = ?auto_10589 ?auto_10591 ) ) ( not ( = ?auto_10589 ?auto_10592 ) ) ( not ( = ?auto_10590 ?auto_10591 ) ) ( not ( = ?auto_10590 ?auto_10592 ) ) ( not ( = ?auto_10591 ?auto_10592 ) ) ( ON ?auto_10590 ?auto_10591 ) ( ON ?auto_10589 ?auto_10590 ) ( ON ?auto_10588 ?auto_10589 ) ( CLEAR ?auto_10588 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_10588 )
      ( MAKE-4PILE ?auto_10588 ?auto_10589 ?auto_10590 ?auto_10591 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_10612 ) ( ON ?auto_10613 ?auto_10614 ) ( CLEAR ?auto_10613 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_10609 ) ( ON ?auto_10610 ?auto_10609 ) ( ON ?auto_10611 ?auto_10610 ) ( ON ?auto_10612 ?auto_10611 ) ( not ( = ?auto_10609 ?auto_10610 ) ) ( not ( = ?auto_10609 ?auto_10611 ) ) ( not ( = ?auto_10609 ?auto_10612 ) ) ( not ( = ?auto_10609 ?auto_10613 ) ) ( not ( = ?auto_10609 ?auto_10614 ) ) ( not ( = ?auto_10610 ?auto_10611 ) ) ( not ( = ?auto_10610 ?auto_10612 ) ) ( not ( = ?auto_10610 ?auto_10613 ) ) ( not ( = ?auto_10610 ?auto_10614 ) ) ( not ( = ?auto_10611 ?auto_10612 ) ) ( not ( = ?auto_10611 ?auto_10613 ) ) ( not ( = ?auto_10611 ?auto_10614 ) ) ( not ( = ?auto_10612 ?auto_10613 ) ) ( not ( = ?auto_10612 ?auto_10614 ) ) ( not ( = ?auto_10613 ?auto_10614 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_10613 ?auto_10614 )
      ( !STACK ?auto_10613 ?auto_10612 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_10635 ?auto_10636 ) ( ON-TABLE ?auto_10631 ) ( ON ?auto_10632 ?auto_10631 ) ( ON ?auto_10633 ?auto_10632 ) ( not ( = ?auto_10631 ?auto_10632 ) ) ( not ( = ?auto_10631 ?auto_10633 ) ) ( not ( = ?auto_10631 ?auto_10634 ) ) ( not ( = ?auto_10631 ?auto_10635 ) ) ( not ( = ?auto_10631 ?auto_10636 ) ) ( not ( = ?auto_10632 ?auto_10633 ) ) ( not ( = ?auto_10632 ?auto_10634 ) ) ( not ( = ?auto_10632 ?auto_10635 ) ) ( not ( = ?auto_10632 ?auto_10636 ) ) ( not ( = ?auto_10633 ?auto_10634 ) ) ( not ( = ?auto_10633 ?auto_10635 ) ) ( not ( = ?auto_10633 ?auto_10636 ) ) ( not ( = ?auto_10634 ?auto_10635 ) ) ( not ( = ?auto_10634 ?auto_10636 ) ) ( not ( = ?auto_10635 ?auto_10636 ) ) ( CLEAR ?auto_10633 ) ( ON ?auto_10634 ?auto_10635 ) ( CLEAR ?auto_10634 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-4PILE ?auto_10631 ?auto_10632 ?auto_10633 ?auto_10634 )
      ( MAKE-5PILE ?auto_10631 ?auto_10632 ?auto_10633 ?auto_10634 ?auto_10635 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_10657 ?auto_10658 ) ( ON-TABLE ?auto_10653 ) ( ON ?auto_10654 ?auto_10653 ) ( not ( = ?auto_10653 ?auto_10654 ) ) ( not ( = ?auto_10653 ?auto_10655 ) ) ( not ( = ?auto_10653 ?auto_10656 ) ) ( not ( = ?auto_10653 ?auto_10657 ) ) ( not ( = ?auto_10653 ?auto_10658 ) ) ( not ( = ?auto_10654 ?auto_10655 ) ) ( not ( = ?auto_10654 ?auto_10656 ) ) ( not ( = ?auto_10654 ?auto_10657 ) ) ( not ( = ?auto_10654 ?auto_10658 ) ) ( not ( = ?auto_10655 ?auto_10656 ) ) ( not ( = ?auto_10655 ?auto_10657 ) ) ( not ( = ?auto_10655 ?auto_10658 ) ) ( not ( = ?auto_10656 ?auto_10657 ) ) ( not ( = ?auto_10656 ?auto_10658 ) ) ( not ( = ?auto_10657 ?auto_10658 ) ) ( ON ?auto_10656 ?auto_10657 ) ( CLEAR ?auto_10654 ) ( ON ?auto_10655 ?auto_10656 ) ( CLEAR ?auto_10655 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_10653 ?auto_10654 ?auto_10655 )
      ( MAKE-5PILE ?auto_10653 ?auto_10654 ?auto_10655 ?auto_10656 ?auto_10657 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_10679 ?auto_10680 ) ( ON-TABLE ?auto_10675 ) ( not ( = ?auto_10675 ?auto_10676 ) ) ( not ( = ?auto_10675 ?auto_10677 ) ) ( not ( = ?auto_10675 ?auto_10678 ) ) ( not ( = ?auto_10675 ?auto_10679 ) ) ( not ( = ?auto_10675 ?auto_10680 ) ) ( not ( = ?auto_10676 ?auto_10677 ) ) ( not ( = ?auto_10676 ?auto_10678 ) ) ( not ( = ?auto_10676 ?auto_10679 ) ) ( not ( = ?auto_10676 ?auto_10680 ) ) ( not ( = ?auto_10677 ?auto_10678 ) ) ( not ( = ?auto_10677 ?auto_10679 ) ) ( not ( = ?auto_10677 ?auto_10680 ) ) ( not ( = ?auto_10678 ?auto_10679 ) ) ( not ( = ?auto_10678 ?auto_10680 ) ) ( not ( = ?auto_10679 ?auto_10680 ) ) ( ON ?auto_10678 ?auto_10679 ) ( ON ?auto_10677 ?auto_10678 ) ( CLEAR ?auto_10675 ) ( ON ?auto_10676 ?auto_10677 ) ( CLEAR ?auto_10676 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_10675 ?auto_10676 )
      ( MAKE-5PILE ?auto_10675 ?auto_10676 ?auto_10677 ?auto_10678 ?auto_10679 ) )
  )
  ...
  ( :method MAKE-5PILE
    ...
    :precondition
    ( and ( ON ?auto_10701 ?auto_10702 ) ( not ( = ?auto_10697 ?auto_10698 ) ) ( not ( = ?auto_10697 ?auto_10699 ) ) ( not ( = ?auto_10697 ?auto_10700 ) ) ( not ( = ?auto_10697 ?auto_10701 ) ) ( not ( = ?auto_10697 ?auto_10702 ) ) ( not ( = ?auto_10698 ?auto_10699 ) ) ( not ( = ?auto_10698 ?auto_10700 ) ) ( not ( = ?auto_10698 ?auto_10701 ) ) ( not ( = ?auto_10698 ?auto_10702 ) ) ( not ( = ?auto_10699 ?auto_10700 ) ) ( not ( = ?auto_10699 ?auto_10701 ) ) ( not ( = ?auto_10699 ?auto_10702 ) ) ( not ( = ?auto_10700 ?auto_10701 ) ) ( not ( = ?auto_10700 ?auto_10702 ) ) ( not ( = ?auto_10701 ?auto_10702 ) ) ( ON ?auto_10700 ?auto_10701 ) ( ON ?auto_10699 ?auto_10700 ) ( ON ?auto_10698 ?auto_10699 ) ( ON ?auto_10697 ?auto_10698 ) ( CLEAR ?auto_10697 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_10697 )
      ( MAKE-5PILE ?auto_10697 ?auto_10698 ?auto_10699 ?auto_10700 ?auto_10701 ) )
  )
