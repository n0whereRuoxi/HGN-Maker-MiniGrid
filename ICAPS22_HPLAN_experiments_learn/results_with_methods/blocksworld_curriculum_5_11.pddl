( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_7740 ?auto_7741 ) ( CLEAR ?auto_7740 ) ( HAND-EMPTY ) ( not ( = ?auto_7740 ?auto_7741 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7740 ?auto_7741 )
      ( !PUTDOWN ?auto_7740 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7749 ) ( ON ?auto_7750 ?auto_7751 ) ( CLEAR ?auto_7750 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7749 ) ( not ( = ?auto_7749 ?auto_7750 ) ) ( not ( = ?auto_7749 ?auto_7751 ) ) ( not ( = ?auto_7750 ?auto_7751 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7750 ?auto_7751 )
      ( !STACK ?auto_7750 ?auto_7749 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_7760 ?auto_7761 ) ( not ( = ?auto_7759 ?auto_7760 ) ) ( not ( = ?auto_7759 ?auto_7761 ) ) ( not ( = ?auto_7760 ?auto_7761 ) ) ( ON ?auto_7759 ?auto_7760 ) ( CLEAR ?auto_7759 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7759 )
      ( MAKE-2PILE ?auto_7759 ?auto_7760 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7773 ) ( ON ?auto_7774 ?auto_7775 ) ( CLEAR ?auto_7774 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7772 ) ( ON ?auto_7773 ?auto_7772 ) ( not ( = ?auto_7772 ?auto_7773 ) ) ( not ( = ?auto_7772 ?auto_7774 ) ) ( not ( = ?auto_7772 ?auto_7775 ) ) ( not ( = ?auto_7773 ?auto_7774 ) ) ( not ( = ?auto_7773 ?auto_7775 ) ) ( not ( = ?auto_7774 ?auto_7775 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7774 ?auto_7775 )
      ( !STACK ?auto_7774 ?auto_7773 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_7788 ?auto_7789 ) ( ON-TABLE ?auto_7786 ) ( not ( = ?auto_7786 ?auto_7787 ) ) ( not ( = ?auto_7786 ?auto_7788 ) ) ( not ( = ?auto_7786 ?auto_7789 ) ) ( not ( = ?auto_7787 ?auto_7788 ) ) ( not ( = ?auto_7787 ?auto_7789 ) ) ( not ( = ?auto_7788 ?auto_7789 ) ) ( CLEAR ?auto_7786 ) ( ON ?auto_7787 ?auto_7788 ) ( CLEAR ?auto_7787 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_7786 ?auto_7787 )
      ( MAKE-3PILE ?auto_7786 ?auto_7787 ?auto_7788 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_7802 ?auto_7803 ) ( not ( = ?auto_7800 ?auto_7801 ) ) ( not ( = ?auto_7800 ?auto_7802 ) ) ( not ( = ?auto_7800 ?auto_7803 ) ) ( not ( = ?auto_7801 ?auto_7802 ) ) ( not ( = ?auto_7801 ?auto_7803 ) ) ( not ( = ?auto_7802 ?auto_7803 ) ) ( ON ?auto_7801 ?auto_7802 ) ( ON ?auto_7800 ?auto_7801 ) ( CLEAR ?auto_7800 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7800 )
      ( MAKE-3PILE ?auto_7800 ?auto_7801 ?auto_7802 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_7819 ) ( ON ?auto_7820 ?auto_7821 ) ( CLEAR ?auto_7820 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_7817 ) ( ON ?auto_7818 ?auto_7817 ) ( ON ?auto_7819 ?auto_7818 ) ( not ( = ?auto_7817 ?auto_7818 ) ) ( not ( = ?auto_7817 ?auto_7819 ) ) ( not ( = ?auto_7817 ?auto_7820 ) ) ( not ( = ?auto_7817 ?auto_7821 ) ) ( not ( = ?auto_7818 ?auto_7819 ) ) ( not ( = ?auto_7818 ?auto_7820 ) ) ( not ( = ?auto_7818 ?auto_7821 ) ) ( not ( = ?auto_7819 ?auto_7820 ) ) ( not ( = ?auto_7819 ?auto_7821 ) ) ( not ( = ?auto_7820 ?auto_7821 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_7820 ?auto_7821 )
      ( !STACK ?auto_7820 ?auto_7819 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7838 ?auto_7839 ) ( ON-TABLE ?auto_7835 ) ( ON ?auto_7836 ?auto_7835 ) ( not ( = ?auto_7835 ?auto_7836 ) ) ( not ( = ?auto_7835 ?auto_7837 ) ) ( not ( = ?auto_7835 ?auto_7838 ) ) ( not ( = ?auto_7835 ?auto_7839 ) ) ( not ( = ?auto_7836 ?auto_7837 ) ) ( not ( = ?auto_7836 ?auto_7838 ) ) ( not ( = ?auto_7836 ?auto_7839 ) ) ( not ( = ?auto_7837 ?auto_7838 ) ) ( not ( = ?auto_7837 ?auto_7839 ) ) ( not ( = ?auto_7838 ?auto_7839 ) ) ( CLEAR ?auto_7836 ) ( ON ?auto_7837 ?auto_7838 ) ( CLEAR ?auto_7837 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_7835 ?auto_7836 ?auto_7837 )
      ( MAKE-4PILE ?auto_7835 ?auto_7836 ?auto_7837 ?auto_7838 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7856 ?auto_7857 ) ( ON-TABLE ?auto_7853 ) ( not ( = ?auto_7853 ?auto_7854 ) ) ( not ( = ?auto_7853 ?auto_7855 ) ) ( not ( = ?auto_7853 ?auto_7856 ) ) ( not ( = ?auto_7853 ?auto_7857 ) ) ( not ( = ?auto_7854 ?auto_7855 ) ) ( not ( = ?auto_7854 ?auto_7856 ) ) ( not ( = ?auto_7854 ?auto_7857 ) ) ( not ( = ?auto_7855 ?auto_7856 ) ) ( not ( = ?auto_7855 ?auto_7857 ) ) ( not ( = ?auto_7856 ?auto_7857 ) ) ( ON ?auto_7855 ?auto_7856 ) ( CLEAR ?auto_7853 ) ( ON ?auto_7854 ?auto_7855 ) ( CLEAR ?auto_7854 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_7853 ?auto_7854 )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_7874 ?auto_7875 ) ( not ( = ?auto_7871 ?auto_7872 ) ) ( not ( = ?auto_7871 ?auto_7873 ) ) ( not ( = ?auto_7871 ?auto_7874 ) ) ( not ( = ?auto_7871 ?auto_7875 ) ) ( not ( = ?auto_7872 ?auto_7873 ) ) ( not ( = ?auto_7872 ?auto_7874 ) ) ( not ( = ?auto_7872 ?auto_7875 ) ) ( not ( = ?auto_7873 ?auto_7874 ) ) ( not ( = ?auto_7873 ?auto_7875 ) ) ( not ( = ?auto_7874 ?auto_7875 ) ) ( ON ?auto_7873 ?auto_7874 ) ( ON ?auto_7872 ?auto_7873 ) ( ON ?auto_7871 ?auto_7872 ) ( CLEAR ?auto_7871 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_7871 )
      ( MAKE-4PILE ?auto_7871 ?auto_7872 ?auto_7873 ?auto_7874 ) )
  )
