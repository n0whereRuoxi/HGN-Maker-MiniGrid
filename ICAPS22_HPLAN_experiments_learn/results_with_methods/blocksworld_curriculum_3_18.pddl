( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1880 ?auto_1881 ) ( CLEAR ?auto_1880 ) ( HAND-EMPTY ) ( not ( = ?auto_1880 ?auto_1881 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1880 ?auto_1881 )
      ( !PUTDOWN ?auto_1880 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1889 ) ( ON ?auto_1890 ?auto_1891 ) ( CLEAR ?auto_1890 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1889 ) ( not ( = ?auto_1889 ?auto_1890 ) ) ( not ( = ?auto_1889 ?auto_1891 ) ) ( not ( = ?auto_1890 ?auto_1891 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1890 ?auto_1891 )
      ( !STACK ?auto_1890 ?auto_1889 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1900 ?auto_1901 ) ( not ( = ?auto_1899 ?auto_1900 ) ) ( not ( = ?auto_1899 ?auto_1901 ) ) ( not ( = ?auto_1900 ?auto_1901 ) ) ( ON ?auto_1899 ?auto_1900 ) ( CLEAR ?auto_1899 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1899 )
      ( MAKE-2PILE ?auto_1899 ?auto_1900 ) )
  )
