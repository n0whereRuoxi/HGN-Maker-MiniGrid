( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1304 ?auto_1305 ) ( CLEAR ?auto_1304 ) ( HAND-EMPTY ) ( not ( = ?auto_1304 ?auto_1305 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1304 ?auto_1305 )
      ( !PUTDOWN ?auto_1304 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1313 ) ( ON ?auto_1314 ?auto_1315 ) ( CLEAR ?auto_1314 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1313 ) ( not ( = ?auto_1313 ?auto_1314 ) ) ( not ( = ?auto_1313 ?auto_1315 ) ) ( not ( = ?auto_1314 ?auto_1315 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1314 ?auto_1315 )
      ( !STACK ?auto_1314 ?auto_1313 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1324 ?auto_1325 ) ( not ( = ?auto_1323 ?auto_1324 ) ) ( not ( = ?auto_1323 ?auto_1325 ) ) ( not ( = ?auto_1324 ?auto_1325 ) ) ( ON ?auto_1323 ?auto_1324 ) ( CLEAR ?auto_1323 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1323 )
