( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1448 ?auto_1449 ) ( CLEAR ?auto_1448 ) ( HAND-EMPTY ) ( not ( = ?auto_1448 ?auto_1449 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1448 ?auto_1449 )
      ( !PUTDOWN ?auto_1448 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1457 ) ( ON ?auto_1458 ?auto_1459 ) ( CLEAR ?auto_1458 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1457 ) ( not ( = ?auto_1457 ?auto_1458 ) ) ( not ( = ?auto_1457 ?auto_1459 ) ) ( not ( = ?auto_1458 ?auto_1459 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1458 ?auto_1459 )
      ( !STACK ?auto_1458 ?auto_1457 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1468 ?auto_1469 ) ( not ( = ?auto_1467 ?auto_1468 ) ) ( not ( = ?auto_1467 ?auto_1469 ) ) ( not ( = ?auto_1468 ?auto_1469 ) ) ( ON ?auto_1467 ?auto_1468 ) ( CLEAR ?auto_1467 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1467 )
