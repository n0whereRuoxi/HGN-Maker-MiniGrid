( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_2024 ?auto_2025 ) ( CLEAR ?auto_2024 ) ( HAND-EMPTY ) ( not ( = ?auto_2024 ?auto_2025 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2024 ?auto_2025 )
      ( !PUTDOWN ?auto_2024 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2033 ) ( ON ?auto_2034 ?auto_2035 ) ( CLEAR ?auto_2034 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2033 ) ( not ( = ?auto_2033 ?auto_2034 ) ) ( not ( = ?auto_2033 ?auto_2035 ) ) ( not ( = ?auto_2034 ?auto_2035 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2034 ?auto_2035 )
      ( !STACK ?auto_2034 ?auto_2033 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_2044 ?auto_2045 ) ( not ( = ?auto_2043 ?auto_2044 ) ) ( not ( = ?auto_2043 ?auto_2045 ) ) ( not ( = ?auto_2044 ?auto_2045 ) ) ( ON ?auto_2043 ?auto_2044 ) ( CLEAR ?auto_2043 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2043 )
      ( MAKE-2PILE ?auto_2043 ?auto_2044 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2057 ) ( ON ?auto_2058 ?auto_2059 ) ( CLEAR ?auto_2058 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2056 ) ( ON ?auto_2057 ?auto_2056 ) ( not ( = ?auto_2056 ?auto_2057 ) ) ( not ( = ?auto_2056 ?auto_2058 ) ) ( not ( = ?auto_2056 ?auto_2059 ) ) ( not ( = ?auto_2057 ?auto_2058 ) ) ( not ( = ?auto_2057 ?auto_2059 ) ) ( not ( = ?auto_2058 ?auto_2059 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2058 ?auto_2059 )
      ( !STACK ?auto_2058 ?auto_2057 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2072 ?auto_2073 ) ( ON-TABLE ?auto_2070 ) ( not ( = ?auto_2070 ?auto_2071 ) ) ( not ( = ?auto_2070 ?auto_2072 ) ) ( not ( = ?auto_2070 ?auto_2073 ) ) ( not ( = ?auto_2071 ?auto_2072 ) ) ( not ( = ?auto_2071 ?auto_2073 ) ) ( not ( = ?auto_2072 ?auto_2073 ) ) ( CLEAR ?auto_2070 ) ( ON ?auto_2071 ?auto_2072 ) ( CLEAR ?auto_2071 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_2070 ?auto_2071 )
      ( MAKE-3PILE ?auto_2070 ?auto_2071 ?auto_2072 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2086 ?auto_2087 ) ( not ( = ?auto_2084 ?auto_2085 ) ) ( not ( = ?auto_2084 ?auto_2086 ) ) ( not ( = ?auto_2084 ?auto_2087 ) ) ( not ( = ?auto_2085 ?auto_2086 ) ) ( not ( = ?auto_2085 ?auto_2087 ) ) ( not ( = ?auto_2086 ?auto_2087 ) ) ( ON ?auto_2085 ?auto_2086 ) ( ON ?auto_2084 ?auto_2085 ) ( CLEAR ?auto_2084 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2084 )
      ( MAKE-3PILE ?auto_2084 ?auto_2085 ?auto_2086 ) )
  )
