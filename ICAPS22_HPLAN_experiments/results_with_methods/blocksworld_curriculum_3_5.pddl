( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_944 ?auto_945 ) ( CLEAR ?auto_944 ) ( HAND-EMPTY ) ( not ( = ?auto_944 ?auto_945 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_944 ?auto_945 )
      ( !PUTDOWN ?auto_944 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_953 ) ( ON ?auto_954 ?auto_955 ) ( CLEAR ?auto_954 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_953 ) ( not ( = ?auto_953 ?auto_954 ) ) ( not ( = ?auto_953 ?auto_955 ) ) ( not ( = ?auto_954 ?auto_955 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_954 ?auto_955 )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_964 ?auto_965 ) ( not ( = ?auto_963 ?auto_964 ) ) ( not ( = ?auto_963 ?auto_965 ) ) ( not ( = ?auto_964 ?auto_965 ) ) ( ON ?auto_963 ?auto_964 ) ( CLEAR ?auto_963 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_963 )
