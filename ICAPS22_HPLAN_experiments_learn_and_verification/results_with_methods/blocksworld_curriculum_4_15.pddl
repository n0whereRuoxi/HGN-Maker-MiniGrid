( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_4199 ?auto_4200 ) ( CLEAR ?auto_4199 ) ( HAND-EMPTY ) ( not ( = ?auto_4199 ?auto_4200 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4199 ?auto_4200 )
      ( !PUTDOWN ?auto_4199 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4208 ) ( ON ?auto_4209 ?auto_4210 ) ( CLEAR ?auto_4209 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4208 ) ( not ( = ?auto_4208 ?auto_4209 ) ) ( not ( = ?auto_4208 ?auto_4210 ) ) ( not ( = ?auto_4209 ?auto_4210 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4209 ?auto_4210 )
      ( !STACK ?auto_4209 ?auto_4208 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_4219 ?auto_4220 ) ( not ( = ?auto_4218 ?auto_4219 ) ) ( not ( = ?auto_4218 ?auto_4220 ) ) ( not ( = ?auto_4219 ?auto_4220 ) ) ( ON ?auto_4218 ?auto_4219 ) ( CLEAR ?auto_4218 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4218 )
      ( MAKE-2PILE ?auto_4218 ?auto_4219 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4232 ) ( ON ?auto_4233 ?auto_4234 ) ( CLEAR ?auto_4233 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4231 ) ( ON ?auto_4232 ?auto_4231 ) ( not ( = ?auto_4231 ?auto_4232 ) ) ( not ( = ?auto_4231 ?auto_4233 ) ) ( not ( = ?auto_4231 ?auto_4234 ) ) ( not ( = ?auto_4232 ?auto_4233 ) ) ( not ( = ?auto_4232 ?auto_4234 ) ) ( not ( = ?auto_4233 ?auto_4234 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4233 ?auto_4234 )
      ( !STACK ?auto_4233 ?auto_4232 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4247 ?auto_4248 ) ( ON-TABLE ?auto_4245 ) ( not ( = ?auto_4245 ?auto_4246 ) ) ( not ( = ?auto_4245 ?auto_4247 ) ) ( not ( = ?auto_4245 ?auto_4248 ) ) ( not ( = ?auto_4246 ?auto_4247 ) ) ( not ( = ?auto_4246 ?auto_4248 ) ) ( not ( = ?auto_4247 ?auto_4248 ) ) ( CLEAR ?auto_4245 ) ( ON ?auto_4246 ?auto_4247 ) ( CLEAR ?auto_4246 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_4245 ?auto_4246 )
      ( MAKE-3PILE ?auto_4245 ?auto_4246 ?auto_4247 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4261 ?auto_4262 ) ( not ( = ?auto_4259 ?auto_4260 ) ) ( not ( = ?auto_4259 ?auto_4261 ) ) ( not ( = ?auto_4259 ?auto_4262 ) ) ( not ( = ?auto_4260 ?auto_4261 ) ) ( not ( = ?auto_4260 ?auto_4262 ) ) ( not ( = ?auto_4261 ?auto_4262 ) ) ( ON ?auto_4260 ?auto_4261 ) ( ON ?auto_4259 ?auto_4260 ) ( CLEAR ?auto_4259 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4259 )
      ( MAKE-3PILE ?auto_4259 ?auto_4260 ?auto_4261 ) )
  )
