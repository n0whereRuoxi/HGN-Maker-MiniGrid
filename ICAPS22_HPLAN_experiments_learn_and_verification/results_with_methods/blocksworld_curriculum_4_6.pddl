( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_2894 ?auto_2895 ) ( CLEAR ?auto_2894 ) ( HAND-EMPTY ) ( not ( = ?auto_2894 ?auto_2895 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2894 ?auto_2895 )
      ( !PUTDOWN ?auto_2894 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2903 ) ( ON ?auto_2904 ?auto_2905 ) ( CLEAR ?auto_2904 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2903 ) ( not ( = ?auto_2903 ?auto_2904 ) ) ( not ( = ?auto_2903 ?auto_2905 ) ) ( not ( = ?auto_2904 ?auto_2905 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2904 ?auto_2905 )
      ( !STACK ?auto_2904 ?auto_2903 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_2914 ?auto_2915 ) ( not ( = ?auto_2913 ?auto_2914 ) ) ( not ( = ?auto_2913 ?auto_2915 ) ) ( not ( = ?auto_2914 ?auto_2915 ) ) ( ON ?auto_2913 ?auto_2914 ) ( CLEAR ?auto_2913 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2913 )
      ( MAKE-2PILE ?auto_2913 ?auto_2914 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2927 ) ( ON ?auto_2928 ?auto_2929 ) ( CLEAR ?auto_2928 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2926 ) ( ON ?auto_2927 ?auto_2926 ) ( not ( = ?auto_2926 ?auto_2927 ) ) ( not ( = ?auto_2926 ?auto_2928 ) ) ( not ( = ?auto_2926 ?auto_2929 ) ) ( not ( = ?auto_2927 ?auto_2928 ) ) ( not ( = ?auto_2927 ?auto_2929 ) ) ( not ( = ?auto_2928 ?auto_2929 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2928 ?auto_2929 )
      ( !STACK ?auto_2928 ?auto_2927 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2942 ?auto_2943 ) ( ON-TABLE ?auto_2940 ) ( not ( = ?auto_2940 ?auto_2941 ) ) ( not ( = ?auto_2940 ?auto_2942 ) ) ( not ( = ?auto_2940 ?auto_2943 ) ) ( not ( = ?auto_2941 ?auto_2942 ) ) ( not ( = ?auto_2941 ?auto_2943 ) ) ( not ( = ?auto_2942 ?auto_2943 ) ) ( CLEAR ?auto_2940 ) ( ON ?auto_2941 ?auto_2942 ) ( CLEAR ?auto_2941 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_2940 ?auto_2941 )
      ( MAKE-3PILE ?auto_2940 ?auto_2941 ?auto_2942 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2956 ?auto_2957 ) ( not ( = ?auto_2954 ?auto_2955 ) ) ( not ( = ?auto_2954 ?auto_2956 ) ) ( not ( = ?auto_2954 ?auto_2957 ) ) ( not ( = ?auto_2955 ?auto_2956 ) ) ( not ( = ?auto_2955 ?auto_2957 ) ) ( not ( = ?auto_2956 ?auto_2957 ) ) ( ON ?auto_2955 ?auto_2956 ) ( ON ?auto_2954 ?auto_2955 ) ( CLEAR ?auto_2954 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2954 )
      ( MAKE-3PILE ?auto_2954 ?auto_2955 ?auto_2956 ) )
  )
