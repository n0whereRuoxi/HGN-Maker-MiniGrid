( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_6460 ?auto_6461 ) ( CLEAR ?auto_6460 ) ( HAND-EMPTY ) ( not ( = ?auto_6460 ?auto_6461 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6460 ?auto_6461 )
      ( !PUTDOWN ?auto_6460 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6469 ) ( ON ?auto_6470 ?auto_6471 ) ( CLEAR ?auto_6470 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6469 ) ( not ( = ?auto_6469 ?auto_6470 ) ) ( not ( = ?auto_6469 ?auto_6471 ) ) ( not ( = ?auto_6470 ?auto_6471 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6470 ?auto_6471 )
      ( !STACK ?auto_6470 ?auto_6469 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_6480 ?auto_6481 ) ( not ( = ?auto_6479 ?auto_6480 ) ) ( not ( = ?auto_6479 ?auto_6481 ) ) ( not ( = ?auto_6480 ?auto_6481 ) ) ( ON ?auto_6479 ?auto_6480 ) ( CLEAR ?auto_6479 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6479 )
      ( MAKE-2PILE ?auto_6479 ?auto_6480 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6493 ) ( ON ?auto_6494 ?auto_6495 ) ( CLEAR ?auto_6494 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6492 ) ( ON ?auto_6493 ?auto_6492 ) ( not ( = ?auto_6492 ?auto_6493 ) ) ( not ( = ?auto_6492 ?auto_6494 ) ) ( not ( = ?auto_6492 ?auto_6495 ) ) ( not ( = ?auto_6493 ?auto_6494 ) ) ( not ( = ?auto_6493 ?auto_6495 ) ) ( not ( = ?auto_6494 ?auto_6495 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6494 ?auto_6495 )
      ( !STACK ?auto_6494 ?auto_6493 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6508 ?auto_6509 ) ( ON-TABLE ?auto_6506 ) ( not ( = ?auto_6506 ?auto_6507 ) ) ( not ( = ?auto_6506 ?auto_6508 ) ) ( not ( = ?auto_6506 ?auto_6509 ) ) ( not ( = ?auto_6507 ?auto_6508 ) ) ( not ( = ?auto_6507 ?auto_6509 ) ) ( not ( = ?auto_6508 ?auto_6509 ) ) ( CLEAR ?auto_6506 ) ( ON ?auto_6507 ?auto_6508 ) ( CLEAR ?auto_6507 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6506 ?auto_6507 )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6522 ?auto_6523 ) ( not ( = ?auto_6520 ?auto_6521 ) ) ( not ( = ?auto_6520 ?auto_6522 ) ) ( not ( = ?auto_6520 ?auto_6523 ) ) ( not ( = ?auto_6521 ?auto_6522 ) ) ( not ( = ?auto_6521 ?auto_6523 ) ) ( not ( = ?auto_6522 ?auto_6523 ) ) ( ON ?auto_6521 ?auto_6522 ) ( ON ?auto_6520 ?auto_6521 ) ( CLEAR ?auto_6520 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6520 )
      ( MAKE-3PILE ?auto_6520 ?auto_6521 ?auto_6522 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6539 ) ( ON ?auto_6540 ?auto_6541 ) ( CLEAR ?auto_6540 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6537 ) ( ON ?auto_6538 ?auto_6537 ) ( ON ?auto_6539 ?auto_6538 ) ( not ( = ?auto_6537 ?auto_6538 ) ) ( not ( = ?auto_6537 ?auto_6539 ) ) ( not ( = ?auto_6537 ?auto_6540 ) ) ( not ( = ?auto_6537 ?auto_6541 ) ) ( not ( = ?auto_6538 ?auto_6539 ) ) ( not ( = ?auto_6538 ?auto_6540 ) ) ( not ( = ?auto_6538 ?auto_6541 ) ) ( not ( = ?auto_6539 ?auto_6540 ) ) ( not ( = ?auto_6539 ?auto_6541 ) ) ( not ( = ?auto_6540 ?auto_6541 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6540 ?auto_6541 )
      ( !STACK ?auto_6540 ?auto_6539 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6558 ?auto_6559 ) ( ON-TABLE ?auto_6555 ) ( ON ?auto_6556 ?auto_6555 ) ( not ( = ?auto_6555 ?auto_6556 ) ) ( not ( = ?auto_6555 ?auto_6557 ) ) ( not ( = ?auto_6555 ?auto_6558 ) ) ( not ( = ?auto_6555 ?auto_6559 ) ) ( not ( = ?auto_6556 ?auto_6557 ) ) ( not ( = ?auto_6556 ?auto_6558 ) ) ( not ( = ?auto_6556 ?auto_6559 ) ) ( not ( = ?auto_6557 ?auto_6558 ) ) ( not ( = ?auto_6557 ?auto_6559 ) ) ( not ( = ?auto_6558 ?auto_6559 ) ) ( CLEAR ?auto_6556 ) ( ON ?auto_6557 ?auto_6558 ) ( CLEAR ?auto_6557 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6576 ?auto_6577 ) ( ON-TABLE ?auto_6573 ) ( not ( = ?auto_6573 ?auto_6574 ) ) ( not ( = ?auto_6573 ?auto_6575 ) ) ( not ( = ?auto_6573 ?auto_6576 ) ) ( not ( = ?auto_6573 ?auto_6577 ) ) ( not ( = ?auto_6574 ?auto_6575 ) ) ( not ( = ?auto_6574 ?auto_6576 ) ) ( not ( = ?auto_6574 ?auto_6577 ) ) ( not ( = ?auto_6575 ?auto_6576 ) ) ( not ( = ?auto_6575 ?auto_6577 ) ) ( not ( = ?auto_6576 ?auto_6577 ) ) ( ON ?auto_6575 ?auto_6576 ) ( CLEAR ?auto_6573 ) ( ON ?auto_6574 ?auto_6575 ) ( CLEAR ?auto_6574 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6573 ?auto_6574 )
      ( MAKE-4PILE ?auto_6573 ?auto_6574 ?auto_6575 ?auto_6576 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6594 ?auto_6595 ) ( not ( = ?auto_6591 ?auto_6592 ) ) ( not ( = ?auto_6591 ?auto_6593 ) ) ( not ( = ?auto_6591 ?auto_6594 ) ) ( not ( = ?auto_6591 ?auto_6595 ) ) ( not ( = ?auto_6592 ?auto_6593 ) ) ( not ( = ?auto_6592 ?auto_6594 ) ) ( not ( = ?auto_6592 ?auto_6595 ) ) ( not ( = ?auto_6593 ?auto_6594 ) ) ( not ( = ?auto_6593 ?auto_6595 ) ) ( not ( = ?auto_6594 ?auto_6595 ) ) ( ON ?auto_6593 ?auto_6594 ) ( ON ?auto_6592 ?auto_6593 ) ( ON ?auto_6591 ?auto_6592 ) ( CLEAR ?auto_6591 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6591 )
      ( MAKE-4PILE ?auto_6591 ?auto_6592 ?auto_6593 ?auto_6594 ) )
  )
