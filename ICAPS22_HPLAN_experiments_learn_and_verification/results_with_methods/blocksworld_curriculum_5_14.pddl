( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_8508 ?auto_8509 ) ( CLEAR ?auto_8508 ) ( HAND-EMPTY ) ( not ( = ?auto_8508 ?auto_8509 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_8508 ?auto_8509 )
      ( !PUTDOWN ?auto_8508 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_8517 ) ( ON ?auto_8518 ?auto_8519 ) ( CLEAR ?auto_8518 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_8517 ) ( not ( = ?auto_8517 ?auto_8518 ) ) ( not ( = ?auto_8517 ?auto_8519 ) ) ( not ( = ?auto_8518 ?auto_8519 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_8518 ?auto_8519 )
      ( !STACK ?auto_8518 ?auto_8517 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_8528 ?auto_8529 ) ( not ( = ?auto_8527 ?auto_8528 ) ) ( not ( = ?auto_8527 ?auto_8529 ) ) ( not ( = ?auto_8528 ?auto_8529 ) ) ( ON ?auto_8527 ?auto_8528 ) ( CLEAR ?auto_8527 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_8527 )
      ( MAKE-2PILE ?auto_8527 ?auto_8528 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_8541 ) ( ON ?auto_8542 ?auto_8543 ) ( CLEAR ?auto_8542 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_8540 ) ( ON ?auto_8541 ?auto_8540 ) ( not ( = ?auto_8540 ?auto_8541 ) ) ( not ( = ?auto_8540 ?auto_8542 ) ) ( not ( = ?auto_8540 ?auto_8543 ) ) ( not ( = ?auto_8541 ?auto_8542 ) ) ( not ( = ?auto_8541 ?auto_8543 ) ) ( not ( = ?auto_8542 ?auto_8543 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_8542 ?auto_8543 )
      ( !STACK ?auto_8542 ?auto_8541 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_8556 ?auto_8557 ) ( ON-TABLE ?auto_8554 ) ( not ( = ?auto_8554 ?auto_8555 ) ) ( not ( = ?auto_8554 ?auto_8556 ) ) ( not ( = ?auto_8554 ?auto_8557 ) ) ( not ( = ?auto_8555 ?auto_8556 ) ) ( not ( = ?auto_8555 ?auto_8557 ) ) ( not ( = ?auto_8556 ?auto_8557 ) ) ( CLEAR ?auto_8554 ) ( ON ?auto_8555 ?auto_8556 ) ( CLEAR ?auto_8555 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_8554 ?auto_8555 )
      ( MAKE-3PILE ?auto_8554 ?auto_8555 ?auto_8556 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_8570 ?auto_8571 ) ( not ( = ?auto_8568 ?auto_8569 ) ) ( not ( = ?auto_8568 ?auto_8570 ) ) ( not ( = ?auto_8568 ?auto_8571 ) ) ( not ( = ?auto_8569 ?auto_8570 ) ) ( not ( = ?auto_8569 ?auto_8571 ) ) ( not ( = ?auto_8570 ?auto_8571 ) ) ( ON ?auto_8569 ?auto_8570 ) ( ON ?auto_8568 ?auto_8569 ) ( CLEAR ?auto_8568 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_8568 )
      ( MAKE-3PILE ?auto_8568 ?auto_8569 ?auto_8570 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_8587 ) ( ON ?auto_8588 ?auto_8589 ) ( CLEAR ?auto_8588 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_8585 ) ( ON ?auto_8586 ?auto_8585 ) ( ON ?auto_8587 ?auto_8586 ) ( not ( = ?auto_8585 ?auto_8586 ) ) ( not ( = ?auto_8585 ?auto_8587 ) ) ( not ( = ?auto_8585 ?auto_8588 ) ) ( not ( = ?auto_8585 ?auto_8589 ) ) ( not ( = ?auto_8586 ?auto_8587 ) ) ( not ( = ?auto_8586 ?auto_8588 ) ) ( not ( = ?auto_8586 ?auto_8589 ) ) ( not ( = ?auto_8587 ?auto_8588 ) ) ( not ( = ?auto_8587 ?auto_8589 ) ) ( not ( = ?auto_8588 ?auto_8589 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_8588 ?auto_8589 )
      ( !STACK ?auto_8588 ?auto_8587 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_8606 ?auto_8607 ) ( ON-TABLE ?auto_8603 ) ( ON ?auto_8604 ?auto_8603 ) ( not ( = ?auto_8603 ?auto_8604 ) ) ( not ( = ?auto_8603 ?auto_8605 ) ) ( not ( = ?auto_8603 ?auto_8606 ) ) ( not ( = ?auto_8603 ?auto_8607 ) ) ( not ( = ?auto_8604 ?auto_8605 ) ) ( not ( = ?auto_8604 ?auto_8606 ) ) ( not ( = ?auto_8604 ?auto_8607 ) ) ( not ( = ?auto_8605 ?auto_8606 ) ) ( not ( = ?auto_8605 ?auto_8607 ) ) ( not ( = ?auto_8606 ?auto_8607 ) ) ( CLEAR ?auto_8604 ) ( ON ?auto_8605 ?auto_8606 ) ( CLEAR ?auto_8605 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_8603 ?auto_8604 ?auto_8605 )
      ( MAKE-4PILE ?auto_8603 ?auto_8604 ?auto_8605 ?auto_8606 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_8624 ?auto_8625 ) ( ON-TABLE ?auto_8621 ) ( not ( = ?auto_8621 ?auto_8622 ) ) ( not ( = ?auto_8621 ?auto_8623 ) ) ( not ( = ?auto_8621 ?auto_8624 ) ) ( not ( = ?auto_8621 ?auto_8625 ) ) ( not ( = ?auto_8622 ?auto_8623 ) ) ( not ( = ?auto_8622 ?auto_8624 ) ) ( not ( = ?auto_8622 ?auto_8625 ) ) ( not ( = ?auto_8623 ?auto_8624 ) ) ( not ( = ?auto_8623 ?auto_8625 ) ) ( not ( = ?auto_8624 ?auto_8625 ) ) ( ON ?auto_8623 ?auto_8624 ) ( CLEAR ?auto_8621 ) ( ON ?auto_8622 ?auto_8623 ) ( CLEAR ?auto_8622 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_8621 ?auto_8622 )
      ( MAKE-4PILE ?auto_8621 ?auto_8622 ?auto_8623 ?auto_8624 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_8642 ?auto_8643 ) ( not ( = ?auto_8639 ?auto_8640 ) ) ( not ( = ?auto_8639 ?auto_8641 ) ) ( not ( = ?auto_8639 ?auto_8642 ) ) ( not ( = ?auto_8639 ?auto_8643 ) ) ( not ( = ?auto_8640 ?auto_8641 ) ) ( not ( = ?auto_8640 ?auto_8642 ) ) ( not ( = ?auto_8640 ?auto_8643 ) ) ( not ( = ?auto_8641 ?auto_8642 ) ) ( not ( = ?auto_8641 ?auto_8643 ) ) ( not ( = ?auto_8642 ?auto_8643 ) ) ( ON ?auto_8641 ?auto_8642 ) ( ON ?auto_8640 ?auto_8641 ) ( ON ?auto_8639 ?auto_8640 ) ( CLEAR ?auto_8639 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_8639 )
      ( MAKE-4PILE ?auto_8639 ?auto_8640 ?auto_8641 ?auto_8642 ) )
  )
