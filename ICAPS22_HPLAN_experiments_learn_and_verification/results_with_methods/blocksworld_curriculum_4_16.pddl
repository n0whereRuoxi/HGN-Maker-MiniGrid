( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_4344 ?auto_4345 ) ( CLEAR ?auto_4344 ) ( HAND-EMPTY ) ( not ( = ?auto_4344 ?auto_4345 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4344 ?auto_4345 )
      ( !PUTDOWN ?auto_4344 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4353 ) ( ON ?auto_4354 ?auto_4355 ) ( CLEAR ?auto_4354 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4353 ) ( not ( = ?auto_4353 ?auto_4354 ) ) ( not ( = ?auto_4353 ?auto_4355 ) ) ( not ( = ?auto_4354 ?auto_4355 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4354 ?auto_4355 )
      ( !STACK ?auto_4354 ?auto_4353 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_4364 ?auto_4365 ) ( not ( = ?auto_4363 ?auto_4364 ) ) ( not ( = ?auto_4363 ?auto_4365 ) ) ( not ( = ?auto_4364 ?auto_4365 ) ) ( ON ?auto_4363 ?auto_4364 ) ( CLEAR ?auto_4363 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4363 )
      ( MAKE-2PILE ?auto_4363 ?auto_4364 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_4377 ) ( ON ?auto_4378 ?auto_4379 ) ( CLEAR ?auto_4378 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_4376 ) ( ON ?auto_4377 ?auto_4376 ) ( not ( = ?auto_4376 ?auto_4377 ) ) ( not ( = ?auto_4376 ?auto_4378 ) ) ( not ( = ?auto_4376 ?auto_4379 ) ) ( not ( = ?auto_4377 ?auto_4378 ) ) ( not ( = ?auto_4377 ?auto_4379 ) ) ( not ( = ?auto_4378 ?auto_4379 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_4378 ?auto_4379 )
      ( !STACK ?auto_4378 ?auto_4377 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4392 ?auto_4393 ) ( ON-TABLE ?auto_4390 ) ( not ( = ?auto_4390 ?auto_4391 ) ) ( not ( = ?auto_4390 ?auto_4392 ) ) ( not ( = ?auto_4390 ?auto_4393 ) ) ( not ( = ?auto_4391 ?auto_4392 ) ) ( not ( = ?auto_4391 ?auto_4393 ) ) ( not ( = ?auto_4392 ?auto_4393 ) ) ( CLEAR ?auto_4390 ) ( ON ?auto_4391 ?auto_4392 ) ( CLEAR ?auto_4391 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_4406 ?auto_4407 ) ( not ( = ?auto_4404 ?auto_4405 ) ) ( not ( = ?auto_4404 ?auto_4406 ) ) ( not ( = ?auto_4404 ?auto_4407 ) ) ( not ( = ?auto_4405 ?auto_4406 ) ) ( not ( = ?auto_4405 ?auto_4407 ) ) ( not ( = ?auto_4406 ?auto_4407 ) ) ( ON ?auto_4405 ?auto_4406 ) ( ON ?auto_4404 ?auto_4405 ) ( CLEAR ?auto_4404 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_4404 )
      ( MAKE-3PILE ?auto_4404 ?auto_4405 ?auto_4406 ) )
  )
