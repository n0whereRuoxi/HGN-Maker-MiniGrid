( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1736 ?auto_1737 ) ( CLEAR ?auto_1736 ) ( HAND-EMPTY ) ( not ( = ?auto_1736 ?auto_1737 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1736 ?auto_1737 )
      ( !PUTDOWN ?auto_1736 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1745 ) ( ON ?auto_1746 ?auto_1747 ) ( CLEAR ?auto_1746 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1745 ) ( not ( = ?auto_1745 ?auto_1746 ) ) ( not ( = ?auto_1745 ?auto_1747 ) ) ( not ( = ?auto_1746 ?auto_1747 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1746 ?auto_1747 )
      ( !STACK ?auto_1746 ?auto_1745 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1756 ?auto_1757 ) ( not ( = ?auto_1755 ?auto_1756 ) ) ( not ( = ?auto_1755 ?auto_1757 ) ) ( not ( = ?auto_1756 ?auto_1757 ) ) ( ON ?auto_1755 ?auto_1756 ) ( CLEAR ?auto_1755 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1755 )
      ( MAKE-2PILE ?auto_1755 ?auto_1756 ) )
  )
