( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_872 ?auto_873 ) ( CLEAR ?auto_872 ) ( HAND-EMPTY ) ( not ( = ?auto_872 ?auto_873 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_872 ?auto_873 )
      ( !PUTDOWN ?auto_872 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_881 ) ( ON ?auto_882 ?auto_883 ) ( CLEAR ?auto_882 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_881 ) ( not ( = ?auto_881 ?auto_882 ) ) ( not ( = ?auto_881 ?auto_883 ) ) ( not ( = ?auto_882 ?auto_883 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_882 ?auto_883 )
      ( !STACK ?auto_882 ?auto_881 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_892 ?auto_893 ) ( not ( = ?auto_891 ?auto_892 ) ) ( not ( = ?auto_891 ?auto_893 ) ) ( not ( = ?auto_892 ?auto_893 ) ) ( ON ?auto_891 ?auto_892 ) ( CLEAR ?auto_891 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_891 )
      ( MAKE-2PILE ?auto_891 ?auto_892 ) )
  )
