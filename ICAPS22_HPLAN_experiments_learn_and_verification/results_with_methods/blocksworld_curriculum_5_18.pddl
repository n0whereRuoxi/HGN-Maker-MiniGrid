( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_9532 ?auto_9533 ) ( CLEAR ?auto_9532 ) ( HAND-EMPTY ) ( not ( = ?auto_9532 ?auto_9533 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_9532 ?auto_9533 )
      ( !PUTDOWN ?auto_9532 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_9541 ) ( ON ?auto_9542 ?auto_9543 ) ( CLEAR ?auto_9542 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_9541 ) ( not ( = ?auto_9541 ?auto_9542 ) ) ( not ( = ?auto_9541 ?auto_9543 ) ) ( not ( = ?auto_9542 ?auto_9543 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_9542 ?auto_9543 )
      ( !STACK ?auto_9542 ?auto_9541 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_9552 ?auto_9553 ) ( not ( = ?auto_9551 ?auto_9552 ) ) ( not ( = ?auto_9551 ?auto_9553 ) ) ( not ( = ?auto_9552 ?auto_9553 ) ) ( ON ?auto_9551 ?auto_9552 ) ( CLEAR ?auto_9551 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_9565 ) ( ON ?auto_9566 ?auto_9567 ) ( CLEAR ?auto_9566 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_9564 ) ( ON ?auto_9565 ?auto_9564 ) ( not ( = ?auto_9564 ?auto_9565 ) ) ( not ( = ?auto_9564 ?auto_9566 ) ) ( not ( = ?auto_9564 ?auto_9567 ) ) ( not ( = ?auto_9565 ?auto_9566 ) ) ( not ( = ?auto_9565 ?auto_9567 ) ) ( not ( = ?auto_9566 ?auto_9567 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_9566 ?auto_9567 )
      ( !STACK ?auto_9566 ?auto_9565 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_9580 ?auto_9581 ) ( ON-TABLE ?auto_9578 ) ( not ( = ?auto_9578 ?auto_9579 ) ) ( not ( = ?auto_9578 ?auto_9580 ) ) ( not ( = ?auto_9578 ?auto_9581 ) ) ( not ( = ?auto_9579 ?auto_9580 ) ) ( not ( = ?auto_9579 ?auto_9581 ) ) ( not ( = ?auto_9580 ?auto_9581 ) ) ( CLEAR ?auto_9578 ) ( ON ?auto_9579 ?auto_9580 ) ( CLEAR ?auto_9579 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_9578 ?auto_9579 )
      ( MAKE-3PILE ?auto_9578 ?auto_9579 ?auto_9580 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_9594 ?auto_9595 ) ( not ( = ?auto_9592 ?auto_9593 ) ) ( not ( = ?auto_9592 ?auto_9594 ) ) ( not ( = ?auto_9592 ?auto_9595 ) ) ( not ( = ?auto_9593 ?auto_9594 ) ) ( not ( = ?auto_9593 ?auto_9595 ) ) ( not ( = ?auto_9594 ?auto_9595 ) ) ( ON ?auto_9593 ?auto_9594 ) ( ON ?auto_9592 ?auto_9593 ) ( CLEAR ?auto_9592 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_9592 )
      ( MAKE-3PILE ?auto_9592 ?auto_9593 ?auto_9594 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_9611 ) ( ON ?auto_9612 ?auto_9613 ) ( CLEAR ?auto_9612 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_9609 ) ( ON ?auto_9610 ?auto_9609 ) ( ON ?auto_9611 ?auto_9610 ) ( not ( = ?auto_9609 ?auto_9610 ) ) ( not ( = ?auto_9609 ?auto_9611 ) ) ( not ( = ?auto_9609 ?auto_9612 ) ) ( not ( = ?auto_9609 ?auto_9613 ) ) ( not ( = ?auto_9610 ?auto_9611 ) ) ( not ( = ?auto_9610 ?auto_9612 ) ) ( not ( = ?auto_9610 ?auto_9613 ) ) ( not ( = ?auto_9611 ?auto_9612 ) ) ( not ( = ?auto_9611 ?auto_9613 ) ) ( not ( = ?auto_9612 ?auto_9613 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_9612 ?auto_9613 )
      ( !STACK ?auto_9612 ?auto_9611 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_9630 ?auto_9631 ) ( ON-TABLE ?auto_9627 ) ( ON ?auto_9628 ?auto_9627 ) ( not ( = ?auto_9627 ?auto_9628 ) ) ( not ( = ?auto_9627 ?auto_9629 ) ) ( not ( = ?auto_9627 ?auto_9630 ) ) ( not ( = ?auto_9627 ?auto_9631 ) ) ( not ( = ?auto_9628 ?auto_9629 ) ) ( not ( = ?auto_9628 ?auto_9630 ) ) ( not ( = ?auto_9628 ?auto_9631 ) ) ( not ( = ?auto_9629 ?auto_9630 ) ) ( not ( = ?auto_9629 ?auto_9631 ) ) ( not ( = ?auto_9630 ?auto_9631 ) ) ( CLEAR ?auto_9628 ) ( ON ?auto_9629 ?auto_9630 ) ( CLEAR ?auto_9629 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_9627 ?auto_9628 ?auto_9629 )
      ( MAKE-4PILE ?auto_9627 ?auto_9628 ?auto_9629 ?auto_9630 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_9648 ?auto_9649 ) ( ON-TABLE ?auto_9645 ) ( not ( = ?auto_9645 ?auto_9646 ) ) ( not ( = ?auto_9645 ?auto_9647 ) ) ( not ( = ?auto_9645 ?auto_9648 ) ) ( not ( = ?auto_9645 ?auto_9649 ) ) ( not ( = ?auto_9646 ?auto_9647 ) ) ( not ( = ?auto_9646 ?auto_9648 ) ) ( not ( = ?auto_9646 ?auto_9649 ) ) ( not ( = ?auto_9647 ?auto_9648 ) ) ( not ( = ?auto_9647 ?auto_9649 ) ) ( not ( = ?auto_9648 ?auto_9649 ) ) ( ON ?auto_9647 ?auto_9648 ) ( CLEAR ?auto_9645 ) ( ON ?auto_9646 ?auto_9647 ) ( CLEAR ?auto_9646 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_9645 ?auto_9646 )
      ( MAKE-4PILE ?auto_9645 ?auto_9646 ?auto_9647 ?auto_9648 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_9666 ?auto_9667 ) ( not ( = ?auto_9663 ?auto_9664 ) ) ( not ( = ?auto_9663 ?auto_9665 ) ) ( not ( = ?auto_9663 ?auto_9666 ) ) ( not ( = ?auto_9663 ?auto_9667 ) ) ( not ( = ?auto_9664 ?auto_9665 ) ) ( not ( = ?auto_9664 ?auto_9666 ) ) ( not ( = ?auto_9664 ?auto_9667 ) ) ( not ( = ?auto_9665 ?auto_9666 ) ) ( not ( = ?auto_9665 ?auto_9667 ) ) ( not ( = ?auto_9666 ?auto_9667 ) ) ( ON ?auto_9665 ?auto_9666 ) ( ON ?auto_9664 ?auto_9665 ) ( ON ?auto_9663 ?auto_9664 ) ( CLEAR ?auto_9663 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_9663 )
      ( MAKE-4PILE ?auto_9663 ?auto_9664 ?auto_9665 ?auto_9666 ) )
  )
