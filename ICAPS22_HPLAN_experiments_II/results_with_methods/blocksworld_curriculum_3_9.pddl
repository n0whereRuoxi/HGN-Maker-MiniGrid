( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1232 ?auto_1233 ) ( CLEAR ?auto_1232 ) ( HAND-EMPTY ) ( not ( = ?auto_1232 ?auto_1233 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1232 ?auto_1233 )
      ( !PUTDOWN ?auto_1232 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1241 ) ( ON ?auto_1242 ?auto_1243 ) ( CLEAR ?auto_1242 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1241 ) ( not ( = ?auto_1241 ?auto_1242 ) ) ( not ( = ?auto_1241 ?auto_1243 ) ) ( not ( = ?auto_1242 ?auto_1243 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1242 ?auto_1243 )
      ( !STACK ?auto_1242 ?auto_1241 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1252 ?auto_1253 ) ( not ( = ?auto_1251 ?auto_1252 ) ) ( not ( = ?auto_1251 ?auto_1253 ) ) ( not ( = ?auto_1252 ?auto_1253 ) ) ( ON ?auto_1251 ?auto_1252 ) ( CLEAR ?auto_1251 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1251 )
      ( MAKE-2PILE ?auto_1251 ?auto_1252 ) )
  )
