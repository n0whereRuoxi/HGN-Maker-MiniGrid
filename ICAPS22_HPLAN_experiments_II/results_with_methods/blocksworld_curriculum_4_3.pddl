( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_2459 ?auto_2460 ) ( CLEAR ?auto_2459 ) ( HAND-EMPTY ) ( not ( = ?auto_2459 ?auto_2460 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2459 ?auto_2460 )
      ( !PUTDOWN ?auto_2459 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2468 ) ( ON ?auto_2469 ?auto_2470 ) ( CLEAR ?auto_2469 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2468 ) ( not ( = ?auto_2468 ?auto_2469 ) ) ( not ( = ?auto_2468 ?auto_2470 ) ) ( not ( = ?auto_2469 ?auto_2470 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2469 ?auto_2470 )
      ( !STACK ?auto_2469 ?auto_2468 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_2479 ?auto_2480 ) ( not ( = ?auto_2478 ?auto_2479 ) ) ( not ( = ?auto_2478 ?auto_2480 ) ) ( not ( = ?auto_2479 ?auto_2480 ) ) ( ON ?auto_2478 ?auto_2479 ) ( CLEAR ?auto_2478 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2478 )
      ( MAKE-2PILE ?auto_2478 ?auto_2479 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_2492 ) ( ON ?auto_2493 ?auto_2494 ) ( CLEAR ?auto_2493 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_2491 ) ( ON ?auto_2492 ?auto_2491 ) ( not ( = ?auto_2491 ?auto_2492 ) ) ( not ( = ?auto_2491 ?auto_2493 ) ) ( not ( = ?auto_2491 ?auto_2494 ) ) ( not ( = ?auto_2492 ?auto_2493 ) ) ( not ( = ?auto_2492 ?auto_2494 ) ) ( not ( = ?auto_2493 ?auto_2494 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_2493 ?auto_2494 )
      ( !STACK ?auto_2493 ?auto_2492 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2507 ?auto_2508 ) ( ON-TABLE ?auto_2505 ) ( not ( = ?auto_2505 ?auto_2506 ) ) ( not ( = ?auto_2505 ?auto_2507 ) ) ( not ( = ?auto_2505 ?auto_2508 ) ) ( not ( = ?auto_2506 ?auto_2507 ) ) ( not ( = ?auto_2506 ?auto_2508 ) ) ( not ( = ?auto_2507 ?auto_2508 ) ) ( CLEAR ?auto_2505 ) ( ON ?auto_2506 ?auto_2507 ) ( CLEAR ?auto_2506 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_2505 ?auto_2506 )
      ( MAKE-3PILE ?auto_2505 ?auto_2506 ?auto_2507 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_2521 ?auto_2522 ) ( not ( = ?auto_2519 ?auto_2520 ) ) ( not ( = ?auto_2519 ?auto_2521 ) ) ( not ( = ?auto_2519 ?auto_2522 ) ) ( not ( = ?auto_2520 ?auto_2521 ) ) ( not ( = ?auto_2520 ?auto_2522 ) ) ( not ( = ?auto_2521 ?auto_2522 ) ) ( ON ?auto_2520 ?auto_2521 ) ( ON ?auto_2519 ?auto_2520 ) ( CLEAR ?auto_2519 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_2519 )
      ( MAKE-3PILE ?auto_2519 ?auto_2520 ?auto_2521 ) )
  )
