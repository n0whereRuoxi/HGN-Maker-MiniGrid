( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_3039 ?auto_3040 ) ( CLEAR ?auto_3039 ) ( HAND-EMPTY ) ( not ( = ?auto_3039 ?auto_3040 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_3039 ?auto_3040 )
      ( !PUTDOWN ?auto_3039 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_3048 ) ( ON ?auto_3049 ?auto_3050 ) ( CLEAR ?auto_3049 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_3048 ) ( not ( = ?auto_3048 ?auto_3049 ) ) ( not ( = ?auto_3048 ?auto_3050 ) ) ( not ( = ?auto_3049 ?auto_3050 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_3049 ?auto_3050 )
      ( !STACK ?auto_3049 ?auto_3048 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_3059 ?auto_3060 ) ( not ( = ?auto_3058 ?auto_3059 ) ) ( not ( = ?auto_3058 ?auto_3060 ) ) ( not ( = ?auto_3059 ?auto_3060 ) ) ( ON ?auto_3058 ?auto_3059 ) ( CLEAR ?auto_3058 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_3058 )
      ( MAKE-2PILE ?auto_3058 ?auto_3059 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_3072 ) ( ON ?auto_3073 ?auto_3074 ) ( CLEAR ?auto_3073 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_3071 ) ( ON ?auto_3072 ?auto_3071 ) ( not ( = ?auto_3071 ?auto_3072 ) ) ( not ( = ?auto_3071 ?auto_3073 ) ) ( not ( = ?auto_3071 ?auto_3074 ) ) ( not ( = ?auto_3072 ?auto_3073 ) ) ( not ( = ?auto_3072 ?auto_3074 ) ) ( not ( = ?auto_3073 ?auto_3074 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_3073 ?auto_3074 )
      ( !STACK ?auto_3073 ?auto_3072 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_3087 ?auto_3088 ) ( ON-TABLE ?auto_3085 ) ( not ( = ?auto_3085 ?auto_3086 ) ) ( not ( = ?auto_3085 ?auto_3087 ) ) ( not ( = ?auto_3085 ?auto_3088 ) ) ( not ( = ?auto_3086 ?auto_3087 ) ) ( not ( = ?auto_3086 ?auto_3088 ) ) ( not ( = ?auto_3087 ?auto_3088 ) ) ( CLEAR ?auto_3085 ) ( ON ?auto_3086 ?auto_3087 ) ( CLEAR ?auto_3086 ) ( HAND-EMPTY ) )
    :subtasks
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_3101 ?auto_3102 ) ( not ( = ?auto_3099 ?auto_3100 ) ) ( not ( = ?auto_3099 ?auto_3101 ) ) ( not ( = ?auto_3099 ?auto_3102 ) ) ( not ( = ?auto_3100 ?auto_3101 ) ) ( not ( = ?auto_3100 ?auto_3102 ) ) ( not ( = ?auto_3101 ?auto_3102 ) ) ( ON ?auto_3100 ?auto_3101 ) ( ON ?auto_3099 ?auto_3100 ) ( CLEAR ?auto_3099 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_3099 )
      ( MAKE-3PILE ?auto_3099 ?auto_3100 ?auto_3101 ) )
  )
