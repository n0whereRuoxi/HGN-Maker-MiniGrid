( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_6716 ?auto_6717 ) ( CLEAR ?auto_6716 ) ( HAND-EMPTY ) ( not ( = ?auto_6716 ?auto_6717 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6716 ?auto_6717 )
      ( !PUTDOWN ?auto_6716 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6725 ) ( ON ?auto_6726 ?auto_6727 ) ( CLEAR ?auto_6726 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6725 ) ( not ( = ?auto_6725 ?auto_6726 ) ) ( not ( = ?auto_6725 ?auto_6727 ) ) ( not ( = ?auto_6726 ?auto_6727 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6726 ?auto_6727 )
      ( !STACK ?auto_6726 ?auto_6725 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_6736 ?auto_6737 ) ( not ( = ?auto_6735 ?auto_6736 ) ) ( not ( = ?auto_6735 ?auto_6737 ) ) ( not ( = ?auto_6736 ?auto_6737 ) ) ( ON ?auto_6735 ?auto_6736 ) ( CLEAR ?auto_6735 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6735 )
      ( MAKE-2PILE ?auto_6735 ?auto_6736 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6749 ) ( ON ?auto_6750 ?auto_6751 ) ( CLEAR ?auto_6750 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6748 ) ( ON ?auto_6749 ?auto_6748 ) ( not ( = ?auto_6748 ?auto_6749 ) ) ( not ( = ?auto_6748 ?auto_6750 ) ) ( not ( = ?auto_6748 ?auto_6751 ) ) ( not ( = ?auto_6749 ?auto_6750 ) ) ( not ( = ?auto_6749 ?auto_6751 ) ) ( not ( = ?auto_6750 ?auto_6751 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6750 ?auto_6751 )
      ( !STACK ?auto_6750 ?auto_6749 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6764 ?auto_6765 ) ( ON-TABLE ?auto_6762 ) ( not ( = ?auto_6762 ?auto_6763 ) ) ( not ( = ?auto_6762 ?auto_6764 ) ) ( not ( = ?auto_6762 ?auto_6765 ) ) ( not ( = ?auto_6763 ?auto_6764 ) ) ( not ( = ?auto_6763 ?auto_6765 ) ) ( not ( = ?auto_6764 ?auto_6765 ) ) ( CLEAR ?auto_6762 ) ( ON ?auto_6763 ?auto_6764 ) ( CLEAR ?auto_6763 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6762 ?auto_6763 )
      ( MAKE-3PILE ?auto_6762 ?auto_6763 ?auto_6764 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_6778 ?auto_6779 ) ( not ( = ?auto_6776 ?auto_6777 ) ) ( not ( = ?auto_6776 ?auto_6778 ) ) ( not ( = ?auto_6776 ?auto_6779 ) ) ( not ( = ?auto_6777 ?auto_6778 ) ) ( not ( = ?auto_6777 ?auto_6779 ) ) ( not ( = ?auto_6778 ?auto_6779 ) ) ( ON ?auto_6777 ?auto_6778 ) ( ON ?auto_6776 ?auto_6777 ) ( CLEAR ?auto_6776 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6776 )
      ( MAKE-3PILE ?auto_6776 ?auto_6777 ?auto_6778 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_6795 ) ( ON ?auto_6796 ?auto_6797 ) ( CLEAR ?auto_6796 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_6793 ) ( ON ?auto_6794 ?auto_6793 ) ( ON ?auto_6795 ?auto_6794 ) ( not ( = ?auto_6793 ?auto_6794 ) ) ( not ( = ?auto_6793 ?auto_6795 ) ) ( not ( = ?auto_6793 ?auto_6796 ) ) ( not ( = ?auto_6793 ?auto_6797 ) ) ( not ( = ?auto_6794 ?auto_6795 ) ) ( not ( = ?auto_6794 ?auto_6796 ) ) ( not ( = ?auto_6794 ?auto_6797 ) ) ( not ( = ?auto_6795 ?auto_6796 ) ) ( not ( = ?auto_6795 ?auto_6797 ) ) ( not ( = ?auto_6796 ?auto_6797 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_6796 ?auto_6797 )
      ( !STACK ?auto_6796 ?auto_6795 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6814 ?auto_6815 ) ( ON-TABLE ?auto_6811 ) ( ON ?auto_6812 ?auto_6811 ) ( not ( = ?auto_6811 ?auto_6812 ) ) ( not ( = ?auto_6811 ?auto_6813 ) ) ( not ( = ?auto_6811 ?auto_6814 ) ) ( not ( = ?auto_6811 ?auto_6815 ) ) ( not ( = ?auto_6812 ?auto_6813 ) ) ( not ( = ?auto_6812 ?auto_6814 ) ) ( not ( = ?auto_6812 ?auto_6815 ) ) ( not ( = ?auto_6813 ?auto_6814 ) ) ( not ( = ?auto_6813 ?auto_6815 ) ) ( not ( = ?auto_6814 ?auto_6815 ) ) ( CLEAR ?auto_6812 ) ( ON ?auto_6813 ?auto_6814 ) ( CLEAR ?auto_6813 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_6811 ?auto_6812 ?auto_6813 )
      ( MAKE-4PILE ?auto_6811 ?auto_6812 ?auto_6813 ?auto_6814 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6832 ?auto_6833 ) ( ON-TABLE ?auto_6829 ) ( not ( = ?auto_6829 ?auto_6830 ) ) ( not ( = ?auto_6829 ?auto_6831 ) ) ( not ( = ?auto_6829 ?auto_6832 ) ) ( not ( = ?auto_6829 ?auto_6833 ) ) ( not ( = ?auto_6830 ?auto_6831 ) ) ( not ( = ?auto_6830 ?auto_6832 ) ) ( not ( = ?auto_6830 ?auto_6833 ) ) ( not ( = ?auto_6831 ?auto_6832 ) ) ( not ( = ?auto_6831 ?auto_6833 ) ) ( not ( = ?auto_6832 ?auto_6833 ) ) ( ON ?auto_6831 ?auto_6832 ) ( CLEAR ?auto_6829 ) ( ON ?auto_6830 ?auto_6831 ) ( CLEAR ?auto_6830 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_6829 ?auto_6830 )
      ( MAKE-4PILE ?auto_6829 ?auto_6830 ?auto_6831 ?auto_6832 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_6850 ?auto_6851 ) ( not ( = ?auto_6847 ?auto_6848 ) ) ( not ( = ?auto_6847 ?auto_6849 ) ) ( not ( = ?auto_6847 ?auto_6850 ) ) ( not ( = ?auto_6847 ?auto_6851 ) ) ( not ( = ?auto_6848 ?auto_6849 ) ) ( not ( = ?auto_6848 ?auto_6850 ) ) ( not ( = ?auto_6848 ?auto_6851 ) ) ( not ( = ?auto_6849 ?auto_6850 ) ) ( not ( = ?auto_6849 ?auto_6851 ) ) ( not ( = ?auto_6850 ?auto_6851 ) ) ( ON ?auto_6849 ?auto_6850 ) ( ON ?auto_6848 ?auto_6849 ) ( ON ?auto_6847 ?auto_6848 ) ( CLEAR ?auto_6847 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_6847 )
      ( MAKE-4PILE ?auto_6847 ?auto_6848 ?auto_6849 ?auto_6850 ) )
  )
