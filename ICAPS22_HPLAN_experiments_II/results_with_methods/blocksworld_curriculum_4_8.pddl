( define ( domain Blocks4 )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_3193 ) ( ON ?auto_3194 ?auto_3195 ) ( CLEAR ?auto_3194 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_3193 ) ( not ( = ?auto_3193 ?auto_3194 ) ) ( not ( = ?auto_3193 ?auto_3195 ) ) ( not ( = ?auto_3194 ?auto_3195 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_3194 ?auto_3195 )
      ( !STACK ?auto_3194 ?auto_3193 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_3204 ?auto_3205 ) ( not ( = ?auto_3203 ?auto_3204 ) ) ( not ( = ?auto_3203 ?auto_3205 ) ) ( not ( = ?auto_3204 ?auto_3205 ) ) ( ON ?auto_3203 ?auto_3204 ) ( CLEAR ?auto_3203 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_3203 )
      ( MAKE-2PILE ?auto_3203 ?auto_3204 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_3217 ) ( ON ?auto_3218 ?auto_3219 ) ( CLEAR ?auto_3218 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_3216 ) ( ON ?auto_3217 ?auto_3216 ) ( not ( = ?auto_3216 ?auto_3217 ) ) ( not ( = ?auto_3216 ?auto_3218 ) ) ( not ( = ?auto_3216 ?auto_3219 ) ) ( not ( = ?auto_3217 ?auto_3218 ) ) ( not ( = ?auto_3217 ?auto_3219 ) ) ( not ( = ?auto_3218 ?auto_3219 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_3218 ?auto_3219 )
      ( !STACK ?auto_3218 ?auto_3217 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_3232 ?auto_3233 ) ( ON-TABLE ?auto_3230 ) ( not ( = ?auto_3230 ?auto_3231 ) ) ( not ( = ?auto_3230 ?auto_3232 ) ) ( not ( = ?auto_3230 ?auto_3233 ) ) ( not ( = ?auto_3231 ?auto_3232 ) ) ( not ( = ?auto_3231 ?auto_3233 ) ) ( not ( = ?auto_3232 ?auto_3233 ) ) ( CLEAR ?auto_3230 ) ( ON ?auto_3231 ?auto_3232 ) ( CLEAR ?auto_3231 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_3230 ?auto_3231 )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_3246 ?auto_3247 ) ( not ( = ?auto_3244 ?auto_3245 ) ) ( not ( = ?auto_3244 ?auto_3246 ) ) ( not ( = ?auto_3244 ?auto_3247 ) ) ( not ( = ?auto_3245 ?auto_3246 ) ) ( not ( = ?auto_3245 ?auto_3247 ) ) ( not ( = ?auto_3246 ?auto_3247 ) ) ( ON ?auto_3245 ?auto_3246 ) ( ON ?auto_3244 ?auto_3245 ) ( CLEAR ?auto_3244 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_3244 )
