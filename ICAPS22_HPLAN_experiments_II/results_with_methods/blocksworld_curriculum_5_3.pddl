( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_5692 ?auto_5693 ) ( CLEAR ?auto_5692 ) ( HAND-EMPTY ) ( not ( = ?auto_5692 ?auto_5693 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_5692 ?auto_5693 )
      ( !PUTDOWN ?auto_5692 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_5701 ) ( ON ?auto_5702 ?auto_5703 ) ( CLEAR ?auto_5702 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_5701 ) ( not ( = ?auto_5701 ?auto_5702 ) ) ( not ( = ?auto_5701 ?auto_5703 ) ) ( not ( = ?auto_5702 ?auto_5703 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_5702 ?auto_5703 )
      ( !STACK ?auto_5702 ?auto_5701 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_5712 ?auto_5713 ) ( not ( = ?auto_5711 ?auto_5712 ) ) ( not ( = ?auto_5711 ?auto_5713 ) ) ( not ( = ?auto_5712 ?auto_5713 ) ) ( ON ?auto_5711 ?auto_5712 ) ( CLEAR ?auto_5711 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_5711 )
      ( MAKE-2PILE ?auto_5711 ?auto_5712 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_5725 ) ( ON ?auto_5726 ?auto_5727 ) ( CLEAR ?auto_5726 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_5724 ) ( ON ?auto_5725 ?auto_5724 ) ( not ( = ?auto_5724 ?auto_5725 ) ) ( not ( = ?auto_5724 ?auto_5726 ) ) ( not ( = ?auto_5724 ?auto_5727 ) ) ( not ( = ?auto_5725 ?auto_5726 ) ) ( not ( = ?auto_5725 ?auto_5727 ) ) ( not ( = ?auto_5726 ?auto_5727 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_5726 ?auto_5727 )
      ( !STACK ?auto_5726 ?auto_5725 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_5740 ?auto_5741 ) ( ON-TABLE ?auto_5738 ) ( not ( = ?auto_5738 ?auto_5739 ) ) ( not ( = ?auto_5738 ?auto_5740 ) ) ( not ( = ?auto_5738 ?auto_5741 ) ) ( not ( = ?auto_5739 ?auto_5740 ) ) ( not ( = ?auto_5739 ?auto_5741 ) ) ( not ( = ?auto_5740 ?auto_5741 ) ) ( CLEAR ?auto_5738 ) ( ON ?auto_5739 ?auto_5740 ) ( CLEAR ?auto_5739 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_5738 ?auto_5739 )
      ( MAKE-3PILE ?auto_5738 ?auto_5739 ?auto_5740 ) )
  )
  ...
  ( :method MAKE-3PILE
    ...
    :precondition
    ( and ( ON ?auto_5754 ?auto_5755 ) ( not ( = ?auto_5752 ?auto_5753 ) ) ( not ( = ?auto_5752 ?auto_5754 ) ) ( not ( = ?auto_5752 ?auto_5755 ) ) ( not ( = ?auto_5753 ?auto_5754 ) ) ( not ( = ?auto_5753 ?auto_5755 ) ) ( not ( = ?auto_5754 ?auto_5755 ) ) ( ON ?auto_5753 ?auto_5754 ) ( ON ?auto_5752 ?auto_5753 ) ( CLEAR ?auto_5752 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_5752 )
      ( MAKE-3PILE ?auto_5752 ?auto_5753 ?auto_5754 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_5771 ) ( ON ?auto_5772 ?auto_5773 ) ( CLEAR ?auto_5772 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_5769 ) ( ON ?auto_5770 ?auto_5769 ) ( ON ?auto_5771 ?auto_5770 ) ( not ( = ?auto_5769 ?auto_5770 ) ) ( not ( = ?auto_5769 ?auto_5771 ) ) ( not ( = ?auto_5769 ?auto_5772 ) ) ( not ( = ?auto_5769 ?auto_5773 ) ) ( not ( = ?auto_5770 ?auto_5771 ) ) ( not ( = ?auto_5770 ?auto_5772 ) ) ( not ( = ?auto_5770 ?auto_5773 ) ) ( not ( = ?auto_5771 ?auto_5772 ) ) ( not ( = ?auto_5771 ?auto_5773 ) ) ( not ( = ?auto_5772 ?auto_5773 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_5772 ?auto_5773 )
      ( !STACK ?auto_5772 ?auto_5771 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_5790 ?auto_5791 ) ( ON-TABLE ?auto_5787 ) ( ON ?auto_5788 ?auto_5787 ) ( not ( = ?auto_5787 ?auto_5788 ) ) ( not ( = ?auto_5787 ?auto_5789 ) ) ( not ( = ?auto_5787 ?auto_5790 ) ) ( not ( = ?auto_5787 ?auto_5791 ) ) ( not ( = ?auto_5788 ?auto_5789 ) ) ( not ( = ?auto_5788 ?auto_5790 ) ) ( not ( = ?auto_5788 ?auto_5791 ) ) ( not ( = ?auto_5789 ?auto_5790 ) ) ( not ( = ?auto_5789 ?auto_5791 ) ) ( not ( = ?auto_5790 ?auto_5791 ) ) ( CLEAR ?auto_5788 ) ( ON ?auto_5789 ?auto_5790 ) ( CLEAR ?auto_5789 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-3PILE ?auto_5787 ?auto_5788 ?auto_5789 )
      ( MAKE-4PILE ?auto_5787 ?auto_5788 ?auto_5789 ?auto_5790 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_5808 ?auto_5809 ) ( ON-TABLE ?auto_5805 ) ( not ( = ?auto_5805 ?auto_5806 ) ) ( not ( = ?auto_5805 ?auto_5807 ) ) ( not ( = ?auto_5805 ?auto_5808 ) ) ( not ( = ?auto_5805 ?auto_5809 ) ) ( not ( = ?auto_5806 ?auto_5807 ) ) ( not ( = ?auto_5806 ?auto_5808 ) ) ( not ( = ?auto_5806 ?auto_5809 ) ) ( not ( = ?auto_5807 ?auto_5808 ) ) ( not ( = ?auto_5807 ?auto_5809 ) ) ( not ( = ?auto_5808 ?auto_5809 ) ) ( ON ?auto_5807 ?auto_5808 ) ( CLEAR ?auto_5805 ) ( ON ?auto_5806 ?auto_5807 ) ( CLEAR ?auto_5806 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-2PILE ?auto_5805 ?auto_5806 )
      ( MAKE-4PILE ?auto_5805 ?auto_5806 ?auto_5807 ?auto_5808 ) )
  )
  ...
  ( :method MAKE-4PILE
    ...
    :precondition
    ( and ( ON ?auto_5826 ?auto_5827 ) ( not ( = ?auto_5823 ?auto_5824 ) ) ( not ( = ?auto_5823 ?auto_5825 ) ) ( not ( = ?auto_5823 ?auto_5826 ) ) ( not ( = ?auto_5823 ?auto_5827 ) ) ( not ( = ?auto_5824 ?auto_5825 ) ) ( not ( = ?auto_5824 ?auto_5826 ) ) ( not ( = ?auto_5824 ?auto_5827 ) ) ( not ( = ?auto_5825 ?auto_5826 ) ) ( not ( = ?auto_5825 ?auto_5827 ) ) ( not ( = ?auto_5826 ?auto_5827 ) ) ( ON ?auto_5825 ?auto_5826 ) ( ON ?auto_5824 ?auto_5825 ) ( ON ?auto_5823 ?auto_5824 ) ( CLEAR ?auto_5823 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_5823 )
      ( MAKE-4PILE ?auto_5823 ?auto_5824 ?auto_5825 ?auto_5826 ) )
  )
