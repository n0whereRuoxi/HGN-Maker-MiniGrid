( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_728 ?auto_729 ) ( CLEAR ?auto_728 ) ( HAND-EMPTY ) ( not ( = ?auto_728 ?auto_729 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_728 ?auto_729 )
      ( !PUTDOWN ?auto_728 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_737 ) ( ON ?auto_738 ?auto_739 ) ( CLEAR ?auto_738 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_737 ) ( not ( = ?auto_737 ?auto_738 ) ) ( not ( = ?auto_737 ?auto_739 ) ) ( not ( = ?auto_738 ?auto_739 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_738 ?auto_739 )
      ( !STACK ?auto_738 ?auto_737 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_748 ?auto_749 ) ( not ( = ?auto_747 ?auto_748 ) ) ( not ( = ?auto_747 ?auto_749 ) ) ( not ( = ?auto_748 ?auto_749 ) ) ( ON ?auto_747 ?auto_748 ) ( CLEAR ?auto_747 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_747 )
      ( MAKE-2PILE ?auto_747 ?auto_748 ) )
  )
