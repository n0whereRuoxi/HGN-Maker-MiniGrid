( define ( domain Blocks4 )
  ...
  ( :method MAKE-1PILE
    ...
    :precondition
    ( and ( ON ?auto_1376 ?auto_1377 ) ( CLEAR ?auto_1376 ) ( HAND-EMPTY ) ( not ( = ?auto_1376 ?auto_1377 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1376 ?auto_1377 )
      ( !PUTDOWN ?auto_1376 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( CLEAR ?auto_1385 ) ( ON ?auto_1386 ?auto_1387 ) ( CLEAR ?auto_1386 ) ( HAND-EMPTY ) ( ON-TABLE ?auto_1385 ) ( not ( = ?auto_1385 ?auto_1386 ) ) ( not ( = ?auto_1385 ?auto_1387 ) ) ( not ( = ?auto_1386 ?auto_1387 ) ) )
    :subtasks
    ( ( !UNSTACK ?auto_1386 ?auto_1387 )
      ( !STACK ?auto_1386 ?auto_1385 ) )
  )
  ...
  ( :method MAKE-2PILE
    ...
    :precondition
    ( and ( ON ?auto_1396 ?auto_1397 ) ( not ( = ?auto_1395 ?auto_1396 ) ) ( not ( = ?auto_1395 ?auto_1397 ) ) ( not ( = ?auto_1396 ?auto_1397 ) ) ( ON ?auto_1395 ?auto_1396 ) ( CLEAR ?auto_1395 ) ( HAND-EMPTY ) )
    :subtasks
    ( ( MAKE-1PILE ?auto_1395 )
      ( MAKE-2PILE ?auto_1395 ?auto_1396 ) )
  )
